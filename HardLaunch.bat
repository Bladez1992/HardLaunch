...
title HardLaunch by Bladez1992 (v1.1.3.0)
color 0c
...
ECHO -----------------------------------------------
ECHO 22. Video Playback Fix (F1.2 thru UIM.03)
ECHO -----------------------------------------------
ECHO 23. Change Interface Colors
ECHO 24. Exit HardLaunch					 
ECHO --------------------------------------------------------------------------
...
if '%choice%'=='22' goto vidplaybackfix
if '%choice%'=='23' goto interface_colors
...
ECHO --------------------------------------------------
ECHO 3.  Run Hardwar - ver. F1.2 (Deutsch)
ECHO 4.  Run Hardwar - ver. F2.0
ECHO 5.  Run Hardwar - ver. F2.1
ECHO 6.  Run Hardwar - ver. U2.04
ECHO --------------------------------------------------
ECHO 7.  Run Hardwar - ver. U3.00b1
ECHO 8.  Run Hardwar - ver. U3.00b2
ECHO 9.  Run Hardwar - ver. U3.00b3
ECHO 10. Run Hardwar - ver. U3.00b4
ECHO 11. Run Hardwar - ver. U3.00b5
ECHO --------------------------------------------------
ECHO 12. Run Hardwar - ver. UIM.01
ECHO 13. Run Hardwar - ver. UIM.02 - Lost to time...
ECHO 14. Run Hardwar - ver. UIM.02.01
ECHO 15. Run Hardwar - ver. UIM.03
ECHO 16. Run Hardwar - ver. UIM.04
ECHO 17. Run Hardwar - ver. UIM.05
ECHO --------------------------------------------------
ECHO 18. Run Hardwar Enhanced - ver. UIM.06
ECHO ----------------------------------------------------------------------------------------------
...
REM --------------------Video Playback (FMV) Fix---------------------------------------------------
:vidplaybackfix
cls
ECHO          - Creates copies of Hardwar's .GDV video files in the following versions -
ECHO         - F1.2   F2.0   F2.1   U2.04   U3.00b1, b2, b3, b4, b5   UIM.01, 02.01, 03 -
ECHO - This is REQUIRED if you want video playback in these versions - Only needs to be done once -
ECHO ----------------------------------------------------------------------------------------------
ECHO  - UIM.04, 05, Enhanced work without the GDVs in the dir or a subdir, so they use UIM.06's -
ECHO ----------------------------------------------------------------------------------------------
ECHO   - ~5.43gb disk space is required - It could take some time to copy on a slow system/disk -
ECHO ----------------------------------------------------------------------------------------------
set /p createbackups=Input Y to proceed with copying, or N to go back to Main Menu: 
if %createbackups%==y goto gdvcopy
if %createbackups%==Y goto gdvcopy
...
@echo off
cls
xcopy "%cd%"\GDV "%cd%"\HardLaunch\VS\F12\GDV /E /Y
ECHO F1.2 (Deutsch) - Done!
timeout /t 2
cls
xcopy "%cd%"\GDV "%cd%"\HardLaunch\VS\F20\GDV /E /Y
ECHO F2.0 - Done!
timeout /t 2
cls
xcopy "%cd%"\GDV "%cd%"\HardLaunch\VS\F21\GDV /E /Y
ECHO F2.1 - Done!
timeout /t 2
cls
xcopy "%cd%"\GDV "%cd%"\HardLaunch\VS\U24\GDV /E /Y
ECHO U2.04 - Done!
timeout /t 2
cls
xcopy "%cd%"\GDV "%cd%"\HardLaunch\VS\B31\GDV /E /Y
ECHO U3.00b1 - Done!
timeout /t 2
cls
xcopy "%cd%"\GDV "%cd%"\HardLaunch\VS\B32\GDV /E /Y
ECHO U3.00b2 - Done!
timeout /t 2
cls
xcopy "%cd%"\GDV "%cd%"\HardLaunch\VS\B33\GDV /E /Y
ECHO U3.00b3 - Done!
timeout /t 2
cls
xcopy "%cd%"\GDV "%cd%"\HardLaunch\VS\B34\GDV /E /Y
ECHO U3.00b4 - Done!
timeout /t 2
cls
xcopy "%cd%"\GDV "%cd%"\HardLaunch\VS\B35\GDV /E /Y
ECHO U3.00b5 - Done!
timeout /t 2
cls
xcopy "%cd%"\GDV "%cd%"\HardLaunch\VS\UM1\GDV /E /Y
ECHO UIM.01 - Done!
timeout /t 2
cls
xcopy "%cd%"\GDV "%cd%"\HardLaunch\VS\U21\GDV /E /Y
ECHO UIM.02.01 - Done!
timeout /t 2
cls
xcopy "%cd%"\GDV "%cd%"\HardLaunch\VS\UM3\GDV /E /Y
ECHO UIM.03 - Done!
ECHO Copied GDV files... There is no need to run this a second time!
timeout /t 10
goto main_menu
