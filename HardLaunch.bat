...
title HardLaunch by Bladez1992 (v1.1.3.1)
color 0c
...
ECHO 6.  Run Hardwar - ver. U1.00 - Lost to time...
...
:u10lost
ECHO Unfortunately U1.00 has been lost to time... let me know if you find it! - Bladez1992#3813 (Discord)
@echo off
timeout /t 10
...
@echo off
mklink /d "%cd%"\HardLaunch\VS\Demo16\ "%cd%"\GDV\
@echo off
...
@echo off
mklink /d "%cd%"\HardLaunch\VS\F12\GDV\ "%cd%"\GDV\
@echo off
xcopy "%cd%"\Music "%cd%"\HardLaunch\VS\F12\Music /E /Y
@echo off
...
@echo off
mklink /d "%cd%"\HardLaunch\VS\F20\GDV\ "%cd%"\GDV\
@echo off
xcopy "%cd%"\Music "%cd%"\HardLaunch\VS\F20\Music /E /Y
@echo off
...
@echo off
xcopy "%cd%"\Music "%cd%"\HardLaunch\VS\F21\Music /E /Y
@echo off
...
@echo off
xcopy "%cd%"\Music "%cd%"\HardLaunch\VS\U24\Music /E /Y
@echo off
...
@echo off
xcopy "%cd%"\Music "%cd%"\HardLaunch\VS\B31\Music /E /Y
@echo off
...
@echo off
xcopy "%cd%"\Music "%cd%"\HardLaunch\VS\B32\Music /E /Y
@echo off
...
@echo off
xcopy "%cd%"\Music "%cd%"\HardLaunch\VS\B33\Music /E /Y
@echo off
...
@echo off
xcopy "%cd%"\Music "%cd%"\HardLaunch\VS\B34\Music /E /Y
@echo off
...
@echo off
xcopy "%cd%"\Music "%cd%"\HardLaunch\VS\B35\Music /E /Y
@echo off
...
@echo off
xcopy "%cd%"\Music "%cd%"\HardLaunch\VS\UM1\Music /E /Y
@echo off
...
@echo off
xcopy "%cd%"\Music "%cd%"\HardLaunch\VS\U21\Music /E /Y
@echo off
...
@echo off
xcopy "%cd%"\Music "%cd%"\HardLaunch\VS\UM3\Music /E /Y
@echo off
...
@echo off
mklink /d "%cd%"\HardLaunch\VS\UM4\GDV\ "%cd%"\GDV\
@echo off
xcopy "%cd%"\Music "%cd%"\HardLaunch\VS\UM4\Music /E /Y
@echo off
...
@echo off
xcopy "%cd%"\Music "%cd%"\HardLaunch\VS\UM5\Music /E /Y
@echo off
...
@echo off
mklink /d "%cd%"\HardLaunch\VS\Enh\GDV\ "%cd%"\GDV\
@echo off
xcopy "%cd%"\Music "%cd%"\HardLaunch\VS\Enh\Music /E /Y
@echo off
