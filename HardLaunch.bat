...
REG ADD HKEY_CURRENT_USER\SOFTWARE\Refinery\HardF12\Config /v KamFong /t REG_SZ /d ChinHo /f
...
REG ADD HKEY_CURRENT_USER\SOFTWARE\Refinery\HardF20\Config /v KamFong /t REG_SZ /d ChinHo /f
...
REG ADD HKEY_CURRENT_USER\SOFTWARE\Refinery\HardF21\Config /v KamFong /t REG_SZ /d ChinHo /f
