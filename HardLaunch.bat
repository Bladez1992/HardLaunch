...
title HardLaunch by Bladez1992 (v1.1.1.9)
color 0c
...
ECHO 16. Mods					 
ECHO 17. Change Interface Colors					 
ECHO --------------------------------------------------------------------------
set choice=
...
if '%choice%'=='17' goto interface_colors
...
REM 3.  U3.00b2 Always Admin			14.  U3.00b2 Always Admin Removal
REM 4.  U3.00b3 Always Admin			15.  U3.00b3 Always Admin Removal
REM 5.  U3.00b4 Always Admin			16.  U3.00b4 Always Admin Removal
REM 6.  U3.00b5 Always Admin			17.  U3.00b5 Always Admin Removal
REM 7.  UIM.01  Always Admin			18.  UIM.01  Always Admin Removal
REM 8.  UIM.02  Always Admin			19.  UIM.02  Always Admin Removal
REM 9.  UIM.03  Always Admin			20.  UIM.03  Always Admin Removal
REM 10. UIM.04  Always Admin			21.  UIM.04  Always Admin Removal
REM 11. UIM.05  Always Admin			22.  UIM.05  Always Admin Removal
ECHO ----------------------------------------------------------------------------------------------
ECHO 				     - Cheats -
...
REM 33.  UIM.02  Spawn at God Hangar			48.  UIM.02  Spawn at God Hangar Removal
...
if %mod%==33 goto godhangarspawnUM2
...
if %mod%==48 goto godhangarspawnremovalUM2
...
set "currentDirectory=%cd%"
@echo off
copy "%cd%"\HardwarW.exe "%cd%"\HardLaunch\EXE\Backups\HardwarWUIM06.exe
del "%cd%"\HardwarW.exe
...
@echo off
copy "%cd%"\DATA\Hardwar.res "%cd%"\HardLaunch\VS\Demo16\Harddem.res
...
@echo off
copy "%cd%"\HardwarW.exe "%cd%"\HardLaunch\EXE\Backups\HardwarWUIM06.exe
copy "%cd%"\Hardman.exe "%cd%"\HardLaunch\EXE\Backups\HardmanUIM06.exe
copy "%cd%"\DATA\Hardwar.res "%cd%"\HardLaunch\VS\F20\HardF20.res
...
@echo off
REG ADD HKEY_CURRENT_USER\SOFTWARE\Refinery\HmanB31\Config /v Skin0 /t REG_SZ /d "%cd%"\HardLaunch\VS\B31\MothSkins\moth_moon.bmp /f
@echo off
REG ADD HKEY_CURRENT_USER\SOFTWARE\Refinery\HmanB31\Config /v Skin1 /t REG_SZ /d "%cd%"\HardLaunch\VS\B31\MothSkins\moth_silver.bmp /f
@echo off
REG ADD HKEY_CURRENT_USER\SOFTWARE\Refinery\HmanB31\Config /v Skin2 /t REG_SZ /d "%cd%"\HardLaunch\VS\B31\MothSkins\moth_neo.bmp /f
@echo off
REG ADD HKEY_CURRENT_USER\SOFTWARE\Refinery\HmanB31\Config /v Skin3 /t REG_SZ /d "%cd%"\HardLaunch\VS\B31\MothSkins\moth_hawk.bmp /f
@echo off
REG ADD HKEY_CURRENT_USER\SOFTWARE\Refinery\HmanB31\Config /v Skin4 /t REG_SZ /d "%cd%"\HardLaunch\VS\B31\MothSkins\moth_death.bmp /f
@echo off
REG ADD HKEY_CURRENT_USER\SOFTWARE\Refinery\HmanB31\Config /v Skin5 /t REG_SZ /d "%cd%"\HardLaunch\VS\B31\MothSkins\moth_police.bmp /f
@echo off
REG ADD HKEY_CURRENT_USER\SOFTWARE\Refinery\HmanB31\Config /v Skin6 /t REG_SZ /d "%cd%"\HardLaunch\VS\B31\MothSkins\moth_swallow.bmp /f
@echo off
REG ADD HKEY_CURRENT_USER\SOFTWARE\Refinery\HmanB31\Config /v SkinsOn /t REG_DWORD /d 0x00000000 /f
@echo off
REG ADD HKEY_CURRENT_USER\SOFTWARE\Refinery\HmanB31\Config /v SkinDir /t REG_SZ /d "%cd%"\HardLaunch\VS\B31\MothSkins\ /f
@echo off
...
copy "%cd%"\Hardman.exe "%cd%"\HardLaunch\EXE\Backups\HardmanUIM06.exe
copy "%cd%"\DATA\Hardup.res "%cd%"\HardLaunch\RES\Backups\HardupUIM06.res
copy "%cd%"\DATA\Hardwar.res "%cd%"\HardLaunch\VS\B31\HardB31.res
...
@echo off
REG ADD HKEY_CURRENT_USER\SOFTWARE\Refinery\HmanB32\Config /v Skin0 /t REG_SZ /d "%cd%"\HardLaunch\VS\B32\MothSkins\moth_moon.bmp /f
@echo off
REG ADD HKEY_CURRENT_USER\SOFTWARE\Refinery\HmanB32\Config /v Skin1 /t REG_SZ /d "%cd%"\HardLaunch\VS\B32\MothSkins\moth_silver.bmp /f
@echo off
REG ADD HKEY_CURRENT_USER\SOFTWARE\Refinery\HmanB32\Config /v Skin2 /t REG_SZ /d "%cd%"\HardLaunch\VS\B32\MothSkins\moth_neo.bmp /f
@echo off
REG ADD HKEY_CURRENT_USER\SOFTWARE\Refinery\HmanB32\Config /v Skin3 /t REG_SZ /d "%cd%"\HardLaunch\VS\B32\MothSkins\moth_hawk.bmp /f
@echo off
REG ADD HKEY_CURRENT_USER\SOFTWARE\Refinery\HmanB32\Config /v Skin4 /t REG_SZ /d "%cd%"\HardLaunch\VS\B32\MothSkins\moth_death.bmp /f
@echo off
REG ADD HKEY_CURRENT_USER\SOFTWARE\Refinery\HmanB32\Config /v Skin5 /t REG_SZ /d "%cd%"\HardLaunch\VS\B32\MothSkins\moth_police.bmp /f
@echo off
REG ADD HKEY_CURRENT_USER\SOFTWARE\Refinery\HmanB32\Config /v Skin6 /t REG_SZ /d "%cd%"\HardLaunch\VS\B32\MothSkins\moth_swallow.bmp /f
@echo off
REG ADD HKEY_CURRENT_USER\SOFTWARE\Refinery\HmanB32\Config /v SkinsOn /t REG_DWORD /d 0x00000000 /f
@echo off
REG ADD HKEY_CURRENT_USER\SOFTWARE\Refinery\HmanB32\Config /v SkinDir /t REG_SZ /d "%cd%"\HardLaunch\VS\B32\MothSkins\ /f
@echo off
...
copy "%cd%"\Hardman.exe "%cd%"\HardLaunch\EXE\Backups\HardmanUIM06.exe
copy "%cd%"\DATA\Hardup.res "%cd%"\HardLaunch\RES\Backups\HardupUIM06.res
copy "%cd%"\DATA\Hardwar.res "%cd%"\HardLaunch\VS\B32\HardB32.res
copy "%cd%"\DATA\Hardim.res "%cd%"\HardLaunch\VS\B32\Hardim.res
...
@echo off
REG ADD HKEY_CURRENT_USER\SOFTWARE\Refinery\HmanB33\Config /v Skin0 /t REG_SZ /d "%cd%"\HardLaunch\VS\B33\MothSkins\moth_moon.bmp /f
@echo off
REG ADD HKEY_CURRENT_USER\SOFTWARE\Refinery\HmanB33\Config /v Skin1 /t REG_SZ /d "%cd%"\HardLaunch\VS\B33\MothSkins\moth_silver.bmp /f
@echo off
REG ADD HKEY_CURRENT_USER\SOFTWARE\Refinery\HmanB33\Config /v Skin2 /t REG_SZ /d "%cd%"\HardLaunch\VS\B33\MothSkins\moth_neo.bmp /f
@echo off
REG ADD HKEY_CURRENT_USER\SOFTWARE\Refinery\HmanB33\Config /v Skin3 /t REG_SZ /d "%cd%"\HardLaunch\VS\B33\MothSkins\moth_hawk.bmp /f
@echo off
REG ADD HKEY_CURRENT_USER\SOFTWARE\Refinery\HmanB33\Config /v Skin4 /t REG_SZ /d "%cd%"\HardLaunch\VS\B33\MothSkins\moth_death.bmp /f
@echo off
REG ADD HKEY_CURRENT_USER\SOFTWARE\Refinery\HmanB33\Config /v Skin5 /t REG_SZ /d "%cd%"\HardLaunch\VS\B33\MothSkins\moth_police.bmp /f
@echo off
REG ADD HKEY_CURRENT_USER\SOFTWARE\Refinery\HmanB33\Config /v Skin6 /t REG_SZ /d "%cd%"\HardLaunch\VS\B33\MothSkins\moth_swallow.bmp /f
@echo off
REG ADD HKEY_CURRENT_USER\SOFTWARE\Refinery\HmanB33\Config /v SkinsOn /t REG_DWORD /d 0x00000000 /f
@echo off
REG ADD HKEY_CURRENT_USER\SOFTWARE\Refinery\HmanB33\Config /v SkinDir /t REG_SZ /d "%cd%"\HardLaunch\VS\B33\MothSkins\ /f
@echo off
...
copy "%cd%"\Hardman.exe "%cd%"\HardLaunch\EXE\Backups\HardmanUIM06.exe
copy "%cd%"\DATA\Hardup.res "%cd%"\HardLaunch\RES\Backups\HardupUIM06.res
copy "%cd%"\DATA\Hardwar.res "%cd%"\HardLaunch\VS\B33\HardB33.res
copy "%cd%"\DATA\Hardim.res "%cd%"\HardLaunch\VS\B33\Hardim.res
...
@echo off
REG ADD HKEY_CURRENT_USER\SOFTWARE\Refinery\HmanB34\Config /v Skin0 /t REG_SZ /d "%cd%"\HardLaunch\VS\B34\MothSkins\moth_moon.bmp /f
@echo off
REG ADD HKEY_CURRENT_USER\SOFTWARE\Refinery\HmanB34\Config /v Skin1 /t REG_SZ /d "%cd%"\HardLaunch\VS\B34\MothSkins\moth_silver.bmp /f
@echo off
REG ADD HKEY_CURRENT_USER\SOFTWARE\Refinery\HmanB34\Config /v Skin2 /t REG_SZ /d "%cd%"\HardLaunch\VS\B34\MothSkins\moth_neo.bmp /f
@echo off
REG ADD HKEY_CURRENT_USER\SOFTWARE\Refinery\HmanB34\Config /v Skin3 /t REG_SZ /d "%cd%"\HardLaunch\VS\B34\MothSkins\moth_hawk.bmp /f
@echo off
REG ADD HKEY_CURRENT_USER\SOFTWARE\Refinery\HmanB34\Config /v Skin4 /t REG_SZ /d "%cd%"\HardLaunch\VS\B34\MothSkins\moth_death.bmp /f
@echo off
REG ADD HKEY_CURRENT_USER\SOFTWARE\Refinery\HmanB34\Config /v Skin5 /t REG_SZ /d "%cd%"\HardLaunch\VS\B34\MothSkins\moth_police.bmp /f
@echo off
REG ADD HKEY_CURRENT_USER\SOFTWARE\Refinery\HmanB34\Config /v Skin6 /t REG_SZ /d "%cd%"\HardLaunch\VS\B34\MothSkins\moth_swallow.bmp /f
@echo off
REG ADD HKEY_CURRENT_USER\SOFTWARE\Refinery\HmanB34\Config /v SkinsOn /t REG_DWORD /d 0x00000000 /f
@echo off
REG ADD HKEY_CURRENT_USER\SOFTWARE\Refinery\HmanB34\Config /v SkinDir /t REG_SZ /d "%cd%"\HardLaunch\VS\B34\MothSkins\ /f
@echo off
...
copy "%cd%"\Hardman.exe "%cd%"\HardLaunch\EXE\Backups\HardmanUIM06.exe
copy "%cd%"\DATA\Hardup.res "%cd%"\HardLaunch\RES\Backups\HardupUIM06.res
copy "%cd%"\DATA\Hardwar.res "%cd%"\HardLaunch\VS\B34\HardB34.res
copy "%cd%"\DATA\Hardim.res "%cd%"\HardLaunch\VS\B34\Hardim.res
...
@echo off
REG ADD HKEY_CURRENT_USER\SOFTWARE\Refinery\HmanB35\Config /v Skin0 /t REG_SZ /d "%cd%"\HardLaunch\VS\B35\MothSkins\moth_moon.bmp /f
@echo off
REG ADD HKEY_CURRENT_USER\SOFTWARE\Refinery\HmanB35\Config /v Skin1 /t REG_SZ /d "%cd%"\HardLaunch\VS\B35\MothSkins\moth_silver.bmp /f
@echo off
REG ADD HKEY_CURRENT_USER\SOFTWARE\Refinery\HmanB35\Config /v Skin2 /t REG_SZ /d "%cd%"\HardLaunch\VS\B35\MothSkins\moth_neo.bmp /f
@echo off
REG ADD HKEY_CURRENT_USER\SOFTWARE\Refinery\HmanB35\Config /v Skin3 /t REG_SZ /d "%cd%"\HardLaunch\VS\B35\MothSkins\moth_hawk.bmp /f
@echo off
REG ADD HKEY_CURRENT_USER\SOFTWARE\Refinery\HmanB35\Config /v Skin4 /t REG_SZ /d "%cd%"\HardLaunch\VS\B35\MothSkins\moth_death.bmp /f
@echo off
REG ADD HKEY_CURRENT_USER\SOFTWARE\Refinery\HmanB35\Config /v Skin5 /t REG_SZ /d "%cd%"\HardLaunch\VS\B35\MothSkins\moth_police.bmp /f
@echo off
REG ADD HKEY_CURRENT_USER\SOFTWARE\Refinery\HmanB35\Config /v Skin6 /t REG_SZ /d "%cd%"\HardLaunch\VS\B35\MothSkins\moth_swallow.bmp /f
@echo off
REG ADD HKEY_CURRENT_USER\SOFTWARE\Refinery\HmanB35\Config /v SkinsOn /t REG_DWORD /d 0x00000000 /f
@echo off
REG ADD HKEY_CURRENT_USER\SOFTWARE\Refinery\HmanB35\Config /v SkinDir /t REG_SZ /d "%cd%"\HardLaunch\VS\B35\MothSkins\ /f
@echo off
...
copy "%cd%"\HardwarW.exe "%cd%"\HardLaunch\EXE\Backups\HardwarWUIM06.exe
copy "%cd%"\Hardman.exe "%cd%"\HardLaunch\EXE\Backups\HardmanUIM06.exe
copy "%cd%"\DATA\Hardup.res "%cd%"\HardLaunch\VS\B35\Hardup.res
copy "%cd%"\DATA\Hardwar.res "%cd%"\HardLaunch\VS\B35\HardB35.res
copy "%cd%"\DATA\Hardim.res "%cd%"\HardLaunch\VS\B35\Hardim.res
...
@echo off
REG ADD HKEY_CURRENT_USER\SOFTWARE\Refinery\HmanUM1\Config /v Skin0 /t REG_SZ /d "%cd%"\HardLaunch\VS\UM1\MothSkins\moth_moon.bmp /f
@echo off
REG ADD HKEY_CURRENT_USER\SOFTWARE\Refinery\HmanUM1\Config /v Skin1 /t REG_SZ /d "%cd%"\HardLaunch\VS\UM1\MothSkins\moth_silver.bmp /f
@echo off
REG ADD HKEY_CURRENT_USER\SOFTWARE\Refinery\HmanUM1\Config /v Skin2 /t REG_SZ /d "%cd%"\HardLaunch\VS\UM1\MothSkins\moth_neo.bmp /f
@echo off
REG ADD HKEY_CURRENT_USER\SOFTWARE\Refinery\HmanUM1\Config /v Skin3 /t REG_SZ /d "%cd%"\HardLaunch\VS\UM1\MothSkins\moth_hawk.bmp /f
@echo off
REG ADD HKEY_CURRENT_USER\SOFTWARE\Refinery\HmanUM1\Config /v Skin4 /t REG_SZ /d "%cd%"\HardLaunch\VS\UM1\MothSkins\moth_death.bmp /f
@echo off
REG ADD HKEY_CURRENT_USER\SOFTWARE\Refinery\HmanUM1\Config /v Skin5 /t REG_SZ /d "%cd%"\HardLaunch\VS\UM1\MothSkins\moth_police.bmp /f
@echo off
REG ADD HKEY_CURRENT_USER\SOFTWARE\Refinery\HmanUM1\Config /v Skin6 /t REG_SZ /d "%cd%"\HardLaunch\VS\UM1\MothSkins\moth_swallow.bmp /f
@echo off
REG ADD HKEY_CURRENT_USER\SOFTWARE\Refinery\HmanUM1\Config /v SkinsOn /t REG_DWORD /d 0x00000000 /f
@echo off
REG ADD HKEY_CURRENT_USER\SOFTWARE\Refinery\HmanUM1\Config /v SkinDir /t REG_SZ /d "%cd%"\HardLaunch\VS\UM1\MothSkins\ /f
@echo off
...
copy "%cd%"\DATA\Hardup.res "%cd%"\HardLaunch\VS\UM1\Hardup.res
copy "%cd%"\DATA\Hardwar.res "%cd%"\HardLaunch\VS\UM1\HardUM1.res
...
@echo off
REG ADD HKEY_CURRENT_USER\SOFTWARE\Refinery\HmanU21\Config /v Skin0 /t REG_SZ /d "%cd%"\HardLaunch\VS\U21\MothSkins\moth_moon.bmp /f
@echo off
REG ADD HKEY_CURRENT_USER\SOFTWARE\Refinery\HmanU21\Config /v Skin1 /t REG_SZ /d "%cd%"\HardLaunch\VS\U21\MothSkins\moth_silver.bmp /f
@echo off
REG ADD HKEY_CURRENT_USER\SOFTWARE\Refinery\HmanU21\Config /v Skin2 /t REG_SZ /d "%cd%"\HardLaunch\VS\U21\MothSkins\moth_neo.bmp /f
@echo off
REG ADD HKEY_CURRENT_USER\SOFTWARE\Refinery\HmanU21\Config /v Skin3 /t REG_SZ /d "%cd%"\HardLaunch\VS\U21\MothSkins\moth_hawk.bmp /f
@echo off
REG ADD HKEY_CURRENT_USER\SOFTWARE\Refinery\HmanU21\Config /v Skin4 /t REG_SZ /d "%cd%"\HardLaunch\VS\U21\MothSkins\moth_death.bmp /f
@echo off
REG ADD HKEY_CURRENT_USER\SOFTWARE\Refinery\HmanU21\Config /v Skin5 /t REG_SZ /d "%cd%"\HardLaunch\VS\U21\MothSkins\moth_police.bmp /f
@echo off
REG ADD HKEY_CURRENT_USER\SOFTWARE\Refinery\HmanU21\Config /v Skin6 /t REG_SZ /d "%cd%"\HardLaunch\VS\U21\MothSkins\moth_swallow.bmp /f
@echo off
REG ADD HKEY_CURRENT_USER\SOFTWARE\Refinery\HmanU21\Config /v SkinsOn /t REG_DWORD /d 0x00000000 /f
@echo off
REG ADD HKEY_CURRENT_USER\SOFTWARE\Refinery\HmanU21\Config /v SkinDir /t REG_SZ /d "%cd%"\HardLaunch\VS\U21\MothSkins\ /f
@echo off
...
copy "%cd%"\Hardman.exe "%cd%"\HardLaunch\EXE\Backups\HardmanUIM06.exe
copy "%cd%"\DATA\Hardim.res "%cd%"\HardLaunch\RES\Backups\HardimUIM06.res
copy "%cd%"\DATA\Hardup.res "%cd%"\HardLaunch\VS\U21\Hardup.res
copy "%cd%"\DATA\Hardwar.res "%cd%"\HardLaunch\VS\U21\HardU21.res
...
@echo off
REG ADD HKEY_CURRENT_USER\SOFTWARE\Refinery\HmanUM3\Config /v Skin0 /t REG_SZ /d "%cd%"\HardLaunch\VS\UM3\MothSkins\moth_moon.bmp /f
@echo off
REG ADD HKEY_CURRENT_USER\SOFTWARE\Refinery\HmanUM3\Config /v Skin1 /t REG_SZ /d "%cd%"\HardLaunch\VS\UM3\MothSkins\moth_silver.bmp /f
@echo off
REG ADD HKEY_CURRENT_USER\SOFTWARE\Refinery\HmanUM3\Config /v Skin2 /t REG_SZ /d "%cd%"\HardLaunch\VS\UM3\MothSkins\moth_neo.bmp /f
@echo off
REG ADD HKEY_CURRENT_USER\SOFTWARE\Refinery\HmanUM3\Config /v Skin3 /t REG_SZ /d "%cd%"\HardLaunch\VS\UM3\MothSkins\moth_hawk.bmp /f
@echo off
REG ADD HKEY_CURRENT_USER\SOFTWARE\Refinery\HmanUM3\Config /v Skin4 /t REG_SZ /d "%cd%"\HardLaunch\VS\UM3\MothSkins\moth_death.bmp /f
@echo off
REG ADD HKEY_CURRENT_USER\SOFTWARE\Refinery\HmanUM3\Config /v Skin5 /t REG_SZ /d "%cd%"\HardLaunch\VS\UM3\MothSkins\moth_police.bmp /f
@echo off
REG ADD HKEY_CURRENT_USER\SOFTWARE\Refinery\HmanUM3\Config /v Skin6 /t REG_SZ /d "%cd%"\HardLaunch\VS\UM3\MothSkins\moth_swallow.bmp /f
@echo off
REG ADD HKEY_CURRENT_USER\SOFTWARE\Refinery\HmanUM3\Config /v SkinsOn /t REG_DWORD /d 0x00000000 /f
@echo off
REG ADD HKEY_CURRENT_USER\SOFTWARE\Refinery\HmanUM3\Config /v SkinDir /t REG_SZ /d "%cd%"\HardLaunch\VS\UM3\MothSkins\ /f
@echo off
...
copy "%cd%"\Hardman.exe "%cd%"\HardLaunch\EXE\Backups\HardmanUIM06.exe
copy "%cd%"\DATA\Hardim.res "%cd%"\HardLaunch\RES\Backups\HardimUIM06.res
copy "%cd%"\DATA\Hardup.res "%cd%"\HardLaunch\VS\UM3\Hardup.res
copy "%cd%"\DATA\Hardwar.res "%cd%"\HardLaunch\VS\UM3\HardUM3.res
...
@echo off
REG ADD HKEY_CURRENT_USER\SOFTWARE\Refinery\HmanUM4\Config /v Skin0 /t REG_SZ /d "%cd%"\HardLaunch\VS\UM4\MothSkins\moth_moon.bmp /f
@echo off
REG ADD HKEY_CURRENT_USER\SOFTWARE\Refinery\HmanUM4\Config /v Skin1 /t REG_SZ /d "%cd%"\HardLaunch\VS\UM4\MothSkins\moth_silver.bmp /f
@echo off
REG ADD HKEY_CURRENT_USER\SOFTWARE\Refinery\HmanUM4\Config /v Skin2 /t REG_SZ /d "%cd%"\HardLaunch\VS\UM4\MothSkins\moth_neo.bmp /f
@echo off
REG ADD HKEY_CURRENT_USER\SOFTWARE\Refinery\HmanUM4\Config /v Skin3 /t REG_SZ /d "%cd%"\HardLaunch\VS\UM4\MothSkins\moth_hawk.bmp /f
@echo off
REG ADD HKEY_CURRENT_USER\SOFTWARE\Refinery\HmanUM4\Config /v Skin4 /t REG_SZ /d "%cd%"\HardLaunch\VS\UM4\MothSkins\moth_death.bmp /f
@echo off
REG ADD HKEY_CURRENT_USER\SOFTWARE\Refinery\HmanUM4\Config /v Skin5 /t REG_SZ /d "%cd%"\HardLaunch\VS\UM4\MothSkins\moth_police.bmp /f
@echo off
REG ADD HKEY_CURRENT_USER\SOFTWARE\Refinery\HmanUM4\Config /v Skin6 /t REG_SZ /d "%cd%"\HardLaunch\VS\UM4\MothSkins\moth_swallow.bmp /f
@echo off
REG ADD HKEY_CURRENT_USER\SOFTWARE\Refinery\HmanUM4\Config /v SkinsOn /t REG_DWORD /d 0x00000000 /f
@echo off
REG ADD HKEY_CURRENT_USER\SOFTWARE\Refinery\HmanUM4\Config /v SkinDir /t REG_SZ /d "%cd%"\HardLaunch\VS\UM4\MothSkins\ /f
@echo off
...
copy "%cd%"\Hardman.exe "%cd%"\HardLaunch\EXE\Backups\HardmanUIM06.exe
copy "%cd%"\DATA\Hardim.res "%cd%"\HardLaunch\RES\Backups\HardimUIM06.res
copy "%cd%"\DATA\Hardup.res "%cd%"\HardLaunch\VS\UM4\Hardup.res
copy "%cd%"\DATA\Hardwar.res "%cd%"\HardLaunch\VS\UM4\HardUM4.res
...
@echo off
REG ADD HKEY_CURRENT_USER\SOFTWARE\Refinery\HmanUM5\Config /v Skin0 /t REG_SZ /d "%cd%"\HardLaunch\VS\UM5\MothSkins\moth_moon.bmp /f
@echo off
REG ADD HKEY_CURRENT_USER\SOFTWARE\Refinery\HmanUM5\Config /v Skin1 /t REG_SZ /d "%cd%"\HardLaunch\VS\UM5\MothSkins\moth_silver.bmp /f
@echo off
REG ADD HKEY_CURRENT_USER\SOFTWARE\Refinery\HmanUM5\Config /v Skin2 /t REG_SZ /d "%cd%"\HardLaunch\VS\UM5\MothSkins\moth_neo.bmp /f
@echo off
REG ADD HKEY_CURRENT_USER\SOFTWARE\Refinery\HmanUM5\Config /v Skin3 /t REG_SZ /d "%cd%"\HardLaunch\VS\UM5\MothSkins\moth_hawk.bmp /f
@echo off
REG ADD HKEY_CURRENT_USER\SOFTWARE\Refinery\HmanUM5\Config /v Skin4 /t REG_SZ /d "%cd%"\HardLaunch\VS\UM5\MothSkins\moth_death.bmp /f
@echo off
REG ADD HKEY_CURRENT_USER\SOFTWARE\Refinery\HmanUM5\Config /v Skin5 /t REG_SZ /d "%cd%"\HardLaunch\VS\UM5\MothSkins\moth_police.bmp /f
@echo off
REG ADD HKEY_CURRENT_USER\SOFTWARE\Refinery\HmanUM5\Config /v Skin6 /t REG_SZ /d "%cd%"\HardLaunch\VS\UM5\MothSkins\moth_swallow.bmp /f
@echo off
REG ADD HKEY_CURRENT_USER\SOFTWARE\Refinery\HmanUM5\Config /v SkinsOn /t REG_DWORD /d 0x00000000 /f
@echo off
REG ADD HKEY_CURRENT_USER\SOFTWARE\Refinery\HmanUM5\Config /v SkinDir /t REG_SZ /d "%cd%"\HardLaunch\VS\UM5\MothSkins\ /f
@echo off
...
copy "%cd%"\Hardman.exe "%cd%"\HardLaunch\EXE\Backups\HardmanUIM06.exe
copy "%cd%"\DATA\Hardim.res "%cd%"\HardLaunch\RES\Backups\HardimUIM06.res
copy "%cd%"\DATA\Hardup.res "%cd%"\HardLaunch\VS\UM5\Hardup.res
copy "%cd%"\DATA\Hardwar.res "%cd%"\HardLaunch\VS\UM5\HardUM5.res
