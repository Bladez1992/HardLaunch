...
title HardLaunch by Bladez1992 (v1.1.3.4)
color 0c
...
ECHO 1.  U3.00b1     12. U3.00b1   Removal		23. Demo D1.6   38. Demo D1.6 Removal
ECHO 2.  U3.00b2     13. U3.00b2   Removal		24. F2.0        39. F2.0      Removal
ECHO 3.  U3.00b3     14. U3.00b3   Removal		25. F2.1        40. F2.1      Removal
ECHO 4.  U3.00b4     15. U3.00b4   Removal		26. U2.04       41. U2.04     Removal
ECHO 5.  U3.00b5     16. U3.00b5   Removal		27. U3.00b1     42. U3.00b1   Removal
ECHO 6.  UIM.01      17. UIM.01    Removal		28. U3.00b2     43. U3.00b2   Removal
ECHO 7.  UIM.02.01   18. UIM.02.01 Removal		29. U3.00b3     44. U3.00b3   Removal
ECHO 8.  UIM.03      19. UIM.03    Removal		30. U3.00b4     45. U3.00b4   Removal
ECHO 9.  UIM.04      20. UIM.04    Removal		31. U3.00b5     46. U3.00b5   Removal
ECHO 10. UIM.05      21. UIM.05    Removal		32. UIM.01      47. UIM.01    Removal
ECHO 11. UIM.06      22. UIM.06    Removal		33. UIM.02.01   48. UIM.02.01 Removal
ECHO							34. UIM.03      49. UIM.03    Removal
ECHO							35. UIM.04      50. UIM.04    Removal
ECHO							36. UIM.05      51. UIM.05    Removal
ECHO							37. UIM.06      52. UIM.06    Removal
ECHO ----------------------Combo Patches (Always Admin + Spawn at God Hangar)----------------------
ECHO 53. U3.00b1     58. U3.00b1   Removal           63. UIM.01      69. UIM.01    Removal
ECHO 54. U3.00b2     59. U3.00b3   Removal           64. UIM.02.01   70. UIM.02.01 Removal
ECHO 55. U3.00b3     60. U3.00b1   Removal           65. UIM.03      71. UIM.03    Removal
ECHO 56. U3.00b4     61. U3.00b1   Removal           66. UIM.04      72. UIM.04    Removal
ECHO 57. U3.00b5     62. U3.00b1   Removal           67. UIM.05      73. UIM.05    Removal
ECHO                                                 68. UIM.06      74. UIM.06    Removal
ECHO --------------------------------------- Cheats -----------------------------------------------
...
if %mod%==7 goto alwaysadminU21
if %mod%==8 goto alwaysadminUM3
if %mod%==9 goto alwaysadminUM4
if %mod%==10 goto alwaysadminUM5
if %mod%==11 goto alwaysadmin
if %mod%==12 goto alwaysadminremovalB31
if %mod%==13 goto alwaysadminremovalB32
if %mod%==14 goto alwaysadminremovalB33
if %mod%==15 goto alwaysadminremovalB34
if %mod%==16 goto alwaysadminremovalB35
if %mod%==17 goto alwaysadminremovalUM1
if %mod%==18 goto alwaysadminremovalU21
if %mod%==19 goto alwaysadminremovalUM3
if %mod%==20 goto alwaysadminremovalUM4
if %mod%==21 goto alwaysadminremovalUM5
if %mod%==22 goto alwaysadminremoval
...
if %mod%==53 goto comboB31
if %mod%==54 goto comboB32
if %mod%==55 goto comboB33
if %mod%==56 goto comboB34
if %mod%==57 goto comboB35
if %mod%==58 goto comboUM1
if %mod%==59 goto comboU21
if %mod%==60 goto comboUM3
if %mod%==61 goto comboUM4
if %mod%==62 goto comboUM5
if %mod%==63 goto comboUM6
if %mod%==64 goto comboremovalB31
if %mod%==65 goto comboremovalB32
if %mod%==66 goto comboremovalB33
if %mod%==67 goto comboremovalB34
if %mod%==68 goto comboremovalB35
if %mod%==69 goto comboremovalUM1
if %mod%==70 goto comboremovalU21
if %mod%==71 goto comboremovalUM3
if %mod%==72 goto comboremovalUM4
if %mod%==73 goto comboremovalUM5
if %mod%==74 goto comboremovalUM6
if %mod%==75 goto main_menu
...
@echo off
del HardwarW.exe
"%cd%"\HardLaunch\#Dependencies\xdelta3.exe -d -s "%cd%"\HardLaunch\EXE\Backups\HardwarW.exe "%cd%"\HardLaunch\EXE\Patches\AAGHCombo.xdelta "%cd%"\HardwarW.exe
...
ECHO 17. Run Hardwar - ver. UIM.02 - Lost to time...
...
goto version_switcher
:um2lost
ECHO Unfortunately UIM.02 has been lost to time... let me know if you find it! - Bladez1992#3813 (Discord)
@echo off
timeout /t 10
goto version_switcher
...
@echo off
REG ADD HKEY_CURRENT_USER\SOFTWARE\Refinery\HmanEnh\Config /v Skin0 /t REG_SZ /d "%cd%"\HardLaunch\VS\Enh\Moth_Skins\moth_moon.bmp /f
@echo off
REG ADD HKEY_CURRENT_USER\SOFTWARE\Refinery\HmanEnh\Config /v Skin1 /t REG_SZ /d "%cd%"\HardLaunch\VS\Enh\Moth_Skins\moth_silver.bmp /f
@echo off
REG ADD HKEY_CURRENT_USER\SOFTWARE\Refinery\HmanEnh\Config /v Skin2 /t REG_SZ /d "%cd%"\HardLaunch\VS\Enh\Moth_Skins\moth_neo.bmp /f
@echo off
REG ADD HKEY_CURRENT_USER\SOFTWARE\Refinery\HmanEnh\Config /v Skin3 /t REG_SZ /d "%cd%"\HardLaunch\VS\Enh\Moth_Skins\moth_hawk.bmp /f
@echo off
REG ADD HKEY_CURRENT_USER\SOFTWARE\Refinery\HmanEnh\Config /v Skin4 /t REG_SZ /d "%cd%"\HardLaunch\VS\Enh\Moth_Skins\moth_death.bmp /f
@echo off
REG ADD HKEY_CURRENT_USER\SOFTWARE\Refinery\HmanEnh\Config /v Skin5 /t REG_SZ /d "%cd%"\HardLaunch\VS\Enh\Moth_Skins\moth_police.bmp /f
@echo off
REG ADD HKEY_CURRENT_USER\SOFTWARE\Refinery\HmanEnh\Config /v Skin6 /t REG_SZ /d "%cd%"\HardLaunch\VS\Enh\Moth_Skins\moth_swallow.bmp /f
@echo off
