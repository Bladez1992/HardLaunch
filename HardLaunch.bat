...
title HardLaunch by Bladez1992 (v1.1.3.7)
color 0c
...
ECHO --------------------------------------------------------------------------
ECHO 1.  Create A New Local World            4.  Load A Local World
ECHO 2.  Create A New Network Game           5.  Load A Network Game
ECHO 3.  Create A New Dedicated Server       6.  Load A Dedicated Server
ECHO                                         7.  Connect (Network or Dedicated)
ECHO --------------------------------------------------------------------------
ECHO -------------------- Game Configuration ----------------------------------
ECHO --------------------------------------------------------------------------
ECHO 8.  Change Resolution                   11. Network Options
ECHO 9.  Graphics Options                    12. Input Options
ECHO 10. Audio Options
ECHO -------------------------------------------------------------
ECHO 13. Debug/Other/Unknown Functions       15. Moth Skin Swapper
ECHO 14. Version Switcher                    16. Mods
ECHO --------------------------------------------------------------------------
ECHO -------------------- Other Options ---------------------------------------
ECHO --------------------------------------------------------------------------
...
cd Savegames
ECHO --------------------------------------------------------------------------
ECHO                           Saved Local Games
dir /b /a-d
ECHO --------------------------------------------------------------------------
set /p LocalSaveName="Name your new Local World (without .sav): "
@echo off
cd ..\
start HardwarW.exe /t:new "%cd%\Savegames\%LocalSaveName%.sav"
goto main_menu
:newnetworld
mkdir Savegames\Network >nul
mode con: cols=75 lines=15
cls
set "currentDirectory=%cd%"
cd Savegames\Network
ECHO --------------------------------------------------------------------------
ECHO                          Saved Network Games
dir /b /a-d
ECHO --------------------------------------------------------------------------
set /p NetSaveName="Name your new Network Game (without .sav): "
@echo off
cd ..\
cd ..\
start HardwarW.exe /t:newserver "%cd%\Savegames\Network\%NetSaveName%.sav"
goto main_menu
:newdedworld
mkdir Savegames\Dedicated >nul
mode con: cols=75 lines=15
cls
set "currentDirectory=%cd%"
cd Savegames\Dedicated
ECHO --------------------------------------------------------------------------
ECHO                          Saved Dedicated Server Games
dir /b /a-d
ECHO --------------------------------------------------------------------------
set /p DedSaveName="Name your new Dedicated Server (without .sav): "
@echo off
cd ..\
cd ..\
start HardwarW.exe /t:newded "%cd%\Savegames\Dedicated\%DedSaveName%.sav"
goto main_menu
:loadworld
mode con: cols=75 lines=15
cls
...
dir /b /a-d
ECHO --------------------------------------------------------------------------
set /p LoadLocalSaveName="Type your Local World's name (without .sav) to load it: "
@echo off
cd ..\
...
cls
set "currentDirectory=%cd%"
cd "%cd%"\Savegames\Network
ECHO --------------------------------------------------------------------------
ECHO                          Saved Network Games
dir /b /a-d
ECHO --------------------------------------------------------------------------
set /p LoadNetSaveName="Type your Network Game's name (without .sav) to load it: "
@echo off
cd ..\
cd ..\
start HardwarW.exe /t:loadserver "%cd%\Savegames\Network\%LoadNetSaveName%.sav"
goto main_menu
:loaddedworld
mkdir Savegames\Dedicated >nul
mode con: cols=75 lines=15
cls
set "currentDirectory=%cd%"
cd "%cd%"\Savegames\Dedicated
ECHO --------------------------------------------------------------------------
ECHO                      Saved Dedicated Server Games
dir /b /a-d
ECHO --------------------------------------------------------------------------
set /p LoadDedSaveName="Type your Dedicated Server's name (without .sav) to load it: "
@echo off
cd ..\
cd ..\
start HardwarW.exe /t:loadded "%cd%\Savegames\Dedicated\%LoadDedSaveName%.sav"
goto main_menu
:connectnetgame
...
ECHO 9.  RGB Display (24/32 bit - For most people this should always be enabled)
ECHO 10. W-Buffering
ECHO 11. Run Hardwar Windowed
ECHO 12. Software Mouse Pointer
ECHO 13. Original Explosions
ECHO 14. Original Fog
ECHO --------------------------------------------------------------------------
ECHO 15. 3D Mode (0 = Primary Display  -  1 = Secondary Display)
ECHO --------------------------------------------------------------------------
ECHO			    --- Others ---
ECHO 16. Phil's Ending
ECHO 17. Skip All Videos
ECHO 18. Simulate Lag
...
if %go%==11 goto windowed
if %go%==12 goto softwaremouse
if %go%==13 goto origexplosions
if %go%==14 goto origfog
if %go%==15 goto 3dmode
if %go%==16 goto philsending
if %go%==17 goto skipgdv
if %go%==18 goto simulatelag
if %go%==19 goto main_menu
...
goto graphics_options
:wbuffering
set /p WB="Type 0 to disable, 1 to enable: "
@echo off 
REG ADD HKEY_CURRENT_USER\SOFTWARE\Refinery\Hardman\Config /v WBuffer /t REG_DWORD /d 0x0000000%WB% /f
ECHO Set W-Buffering Value - Done!
@echo off
timeout /t 5
goto graphics_options
:windowed
set /p WD="Type 0 to disable, 1 to enable: "
@echo off 
REG ADD HKEY_CURRENT_USER\SOFTWARE\Refinery\Hardman\Config /v Windowed /t REG_DWORD /d 0x0000000%WD% /f
ECHO Set Windowed Value - Done!
@echo off
timeout /t 5
goto graphics_options
:softwaremouse
set /p SM="Type 0 to disable, 1 to enable: "
@echo off 
REG ADD HKEY_CURRENT_USER\SOFTWARE\Refinery\Hardman\Config /v SoftCursor /t REG_DWORD /d 0x0000000%SM% /f
ECHO Set Software Mouse Pointer Value - Done!
@echo off
timeout /t 5
goto graphics_options
:3dmode
set /p 3d="0 = Primary Display  -  1 = Secondary Display: "
@echo off 
REG ADD HKEY_CURRENT_USER\SOFTWARE\Refinery\Hardman\Config /v 3DMode /t REG_DWORD /d 0x0000000%3d% /f
ECHO Set 3D Mode Value - Done!
@echo off
timeout /t 5
goto graphics_options
...
:forcefeedback
set /p ff="Type 0 to disable, 1 to enable: "
@echo off 
...
goto input_options
:joystickmbd
set /p jb="Type 0 to disable, 1 to enable: "
@echo off 
...
goto input_options
:povhat
set /p ph="Type 0 to disable, 1 to enable: "
@echo off 
...
goto input_options
:rudder
set /p ru="Type 0 to disable, 1 to enable: "
@echo off 
...
ECHO 1.  Allow Multiple Hardwar Instances
ECHO 2.  Attract Mode When Idle (AI pilots will target you when idle)
...
ECHO 18. Video Format
ECHO 19. Back to Main Menu
ECHO --------------------------------------------------------------------------
SET /P of=Type the number of your selection:
if %of%==1 goto multipleinstances
if %of%==2 goto attractmode
...
:multipleinstances
set /p mi="Type 0 to disable, 1 to enable: "
@echo off 
REG ADD HKEY_CURRENT_USER\SOFTWARE\Refinery\Hardman\Config /v AllowMultipleInstances /t REG_DWORD /d 0x0000000%mi% /f
ECHO Set Allow Multiple Hardwar Instances Value - Done!
@echo off
timeout /t 5
goto dou_functions
:attractmode
...
goto end
:videoformat
set /p vf="Type 0 to disable, 1 to enable: "
@echo off 
REG ADD HKEY_CURRENT_USER\SOFTWARE\Refinery\Hardman\Config /v VideoFormat /t REG_DWORD /d 0x0000000%vf% /f
ECHO Set Video Format Value - Done!
@echo off
timeout /t 5
goto dou_functions
...
ECHO ----------------------------------------------------------------------------------------------
ECHO       --- Always Admin Patches ---                   --- Spawn at God Hangar Patches ---
ECHO - Enables cheats using any username -            - All Configurations spawn at God Hangar -
ECHO 1.  U3.00b1     13. U3.00b1   Removal		25. Demo D1.6   41. Demo D1.6 Removal
ECHO 2.  U3.00b2     14. U3.00b2   Removal		26. F2.0        42. F2.0      Removal
ECHO 3.  U3.00b3     15. U3.00b3   Removal		27. F2.1        43. F2.1      Removal
ECHO 4.  U3.00b4     16. U3.00b4   Removal		28. U2.04       44. U2.04     Removal
ECHO 5.  U3.00b5     17. U3.00b5   Removal		29. U3.00b1     45. U3.00b1   Removal
ECHO 6.  UIM.01      18. UIM.01    Removal		30. U3.00b2     46. U3.00b2   Removal
ECHO 7.  UIM.02      19. UIM.02    Removal		31. U3.00b3     47. U3.00b3   Removal
ECHO 8.  UIM.02.01   20. UIM.02.01 Removal		32. U3.00b4     48. U3.00b4   Removal
ECHO 9.  UIM.03      21. UIM.03    Removal		33. U3.00b5     49. U3.00b5   Removal
ECHO 10. UIM.04      22. UIM.04    Removal		34. UIM.01      50. UIM.01    Removal
ECHO 11. UIM.05      23. UIM.05    Removal		35. UIM.02      51. UIM.02    Removal
ECHO 12. UIM.06      24. UIM.06    Removal		36. UIM.02.01   52. UIM.02.01 Removal
ECHO							37. UIM.03      53. UIM.03    Removal
ECHO							38. UIM.04      54. UIM.04    Removal
ECHO							39. UIM.05      55. UIM.05    Removal
ECHO							40. UIM.06      56. UIM.06    Removal
ECHO ----------------------Combo Patches (Always Admin + Spawn at God Hangar)----------------------
ECHO 57. U3.00b1     62. U3.00b1   Removal           67. UIM.01      74. UIM.01    Removal
ECHO 58. U3.00b2     63. U3.00b2   Removal           68. UIM.02      75. UIM.02    Removal
ECHO 59. U3.00b3     64. U3.00b3   Removal           69. UIM.02.01   76. UIM.02.01 Removal
ECHO 60. U3.00b4     65. U3.00b4   Removal           70. UIM.03      77. UIM.03    Removal
ECHO 61. U3.00b5     66. U3.00b5   Removal           71. UIM.04      78. UIM.04    Removal
ECHO                                                 72. UIM.05      79. UIM.05    Removal
ECHO                                                 73. UIM.06      80. UIM.06    Removal
ECHO --------------------------------------- Cheats -----------------------------------------------
ECHO    Open the system console by pressing o then type a command to blag (spawn) cash or a moth
ECHO ----------------------------------------------------------------------------------------------
...
ECHO ----------------------------------------------------------------------------------------------
ECHO 81.  Back to Main Menu
ECHO ----------------------------------------------------------------------------------------------
SET /P mod=Type the number of your selection: 
if %mod%==1 goto alwaysadminB31
if %mod%==2 goto alwaysadminB32
if %mod%==3 goto alwaysadminB33
if %mod%==4 goto alwaysadminB34
if %mod%==5 goto alwaysadminB35
if %mod%==6 goto alwaysadminUM1
if %mod%==7 goto alwaysadminUM2
if %mod%==8 goto alwaysadminU21
if %mod%==9 goto alwaysadminUM3
if %mod%==10 goto alwaysadminUM4
if %mod%==11 goto alwaysadminUM5
if %mod%==12 goto alwaysadmin
...
if %mod%==19 goto alwaysadminremovalUM2
if %mod%==20 goto alwaysadminremovalU21
if %mod%==21 goto alwaysadminremovalUM3
if %mod%==22 goto alwaysadminremovalUM4
if %mod%==23 goto alwaysadminremovalUM5
if %mod%==24 goto alwaysadminremoval
if %mod%==25 goto demogodhangarspawn
if %mod%==26 goto godhangarspawnF20
if %mod%==27 goto godhangarspawnF21
if %mod%==28 goto godhangarspawnU24
if %mod%==29 goto godhangarspawnB31
if %mod%==30 goto godhangarspawnB32
if %mod%==31 goto godhangarspawnB33
if %mod%==32 goto godhangarspawnB34
if %mod%==33 goto godhangarspawnB35
if %mod%==34 goto godhangarspawnUM1
if %mod%==35 goto godhangarspawnUM2
if %mod%==36 goto godhangarspawnU21
if %mod%==37 goto godhangarspawnUM3
if %mod%==38 goto godhangarspawnUM4
if %mod%==39 goto godhangarspawnUM5
if %mod%==40 goto godhangarspawnUM6
if %mod%==41 goto demogodhangarspawnremoval
if %mod%==42 goto godhangarspawnremovalF20
if %mod%==43 goto godhangarspawnremovalF21
if %mod%==44 goto godhangarspawnremovalU24
if %mod%==45 goto godhangarspawnremovalB31
if %mod%==46 goto godhangarspawnremovalB32
if %mod%==47 goto godhangarspawnremovalB33
if %mod%==48 goto godhangarspawnremovalB34
if %mod%==49 goto godhangarspawnremovalB35
if %mod%==50 goto godhangarspawnremovalUM1
if %mod%==51 goto godhangarspawnremovalUM2
if %mod%==52 goto godhangarspawnremovalU21
if %mod%==53 goto godhangarspawnremovalUM3
if %mod%==54 goto godhangarspawnremovalUM4
if %mod%==55 goto godhangarspawnremovalUM5
if %mod%==56 goto godhangarspawnremovalUM6
if %mod%==57 goto comboB31
if %mod%==58 goto comboB32
if %mod%==59 goto comboB33
if %mod%==60 goto comboB34
if %mod%==61 goto comboB35
if %mod%==62 goto comboremovalB31
if %mod%==63 goto comboremovalB32
if %mod%==64 goto comboremovalB33
if %mod%==65 goto comboremovalB34
if %mod%==66 goto comboremovalB35
if %mod%==67 goto comboUM1
if %mod%==68 goto comboUM2
if %mod%==69 goto comboU21
if %mod%==70 goto comboUM3
if %mod%==71 goto comboUM4
if %mod%==72 goto comboUM5
if %mod%==73 goto comboUM6
if %mod%==74 goto comboremovalUM1
if %mod%==75 goto comboremovalUM2
if %mod%==76 goto comboremovalU21
if %mod%==77 goto comboremovalUM3
if %mod%==78 goto comboremovalUM4
if %mod%==79 goto comboremovalUM5
if %mod%==80 goto comboremovalUM6
if %mod%==81 goto main_menu
...
ECHO Apply Always Admin patch to HardwarW.exe (UIM.06) - Done!
ECHO Remember that this will break the version switcher until reverted...
@echo off
timeout /t 10
goto mods
...
set "currentDirectory=%cd%"
@echo off
copy "%cd%"\HardLaunch\VS\UM2\HardWUM2.exe "%cd%"\HardLaunch\EXE\Backups\HardWUM2.exe
del "%cd%"\HardLaunch\VS\UM2\HardWUM2.exe
"%cd%"\HardLaunch\#Dependencies\xdelta3.exe -d -s "%cd%"\HardLaunch\EXE\Backups\HardWUM2.exe "%cd%"\HardLaunch\VS\UM2\Patches\Admin.xdelta "%cd%"\HardLaunch\VS\UM2\HardWUM2.exe
ECHO Apply Always Admin patch to HardWUM2.exe (UIM.01) - Done!
@echo off
timeout /t 5
goto mods
...
ECHO Remove Always Admin patch from HardwarW.exe (UIM.06) - Done!
ECHO Remember that this will break the version switcher until reverted...
@echo off
timeout /t 10
goto mods
...
ECHO Remove Always Admin patch from HardWB31.exe (U3.00b1) - Done!
@echo off
timeout /t 5
goto mods
...
ECHO Remove Always Admin patch from HardWB32.exe (U3.00b2) - Done!
@echo off
timeout /t 5
goto mods
...
ECHO Remove Always Admin patch from HardWB33.exe (U3.00b3) - Done!
@echo off
timeout /t 5
goto mods
...
ECHO Remove Always Admin patch from HardWB34.exe (U3.00b4)- Done!
@echo off
timeout /t 5
goto mods
...
ECHO Remove Always Admin patch from HardWB35.exe (U3.00b5) - Done!
@echo off
timeout /t 5
goto mods
...
ECHO Remove Always Admin patch from HardWUM1.exe (UIM.01) - Done!
@echo off
timeout /t 5
goto mods

:alwaysadminremovalUM2
@echo off
set "currentDirectory=%cd%"
@echo off
del "%cd%"\HardLaunch\VS\UM2\HardWUM2.exe
copy "%cd%"\HardLaunch\EXE\Backups\HardWUM2.exe "%cd%"\HardLaunch\VS\UM2\HardWUM2.exe
ECHO Remove Always Admin patch from HardWUM2.exe (UIM.02) - Done!
@echo off
timeout /t 5
goto mods
...
ECHO Remove Always Admin patch from HardWU21.exe (UIM.02.01) - Done!
@echo off
timeout /t 5
goto mods
...
ECHO Remove Always Admin patch from HardWUM4.exe (UIM.04) - Done!
@echo off
timeout /t 5
goto mods
...
ECHO Remove Always Admin patch from HardWUM5.exe (UIM.05) - Done!
@echo off
timeout /t 5
goto mods
...
set "currentDirectory=%cd%"
@echo off
copy "%cd%"\HardLaunch\VS\F20\HardWF20.exe "%cd%"\HardLaunch\EXE\Backups\HardWF20.exe
del "%cd%"\HardLaunch\VS\F20\HardWF20.exe
"%cd%"\HardLaunch\#Dependencies\xdelta3.exe -d -s "%cd%"\HardLaunch\EXE\Backups\HardWF20.exe "%cd%"\HardLaunch\VS\F20\Patches\GodHangarSpawn.xdelta "%cd%"\HardLaunch\VS\F20\HardWF20.exe
ECHO Apply God Hangar Spawn patch to HardWF20.exe (F2.0) - Done!
@echo off
timeout /t 5
goto mods
...
set "currentDirectory=%cd%"
@echo off
copy "%cd%"\HardLaunch\VS\F21\HardWF21.exe "%cd%"\HardLaunch\EXE\Backups\HardWF21.exe
del "%cd%"\HardLaunch\VS\F21\HardWF21.exe
"%cd%"\HardLaunch\#Dependencies\xdelta3.exe -d -s "%cd%"\HardLaunch\EXE\Backups\HardWF21.exe "%cd%"\HardLaunch\VS\F21\Patches\GodHangarSpawn.xdelta "%cd%"\HardLaunch\VS\F21\HardWF21.exe
ECHO Apply God Hangar Spawn patch to HardWF21.exe (F2.1) - Done!
@echo off
timeout /t 5
goto mods
...
set "currentDirectory=%cd%"
@echo off
copy "%cd%"\HardLaunch\VS\U24\HardWU24.exe "%cd%"\HardLaunch\EXE\Backups\HardWU24.exe
del "%cd%"\HardLaunch\VS\U24\HardWU24.exe
"%cd%"\HardLaunch\#Dependencies\xdelta3.exe -d -s "%cd%"\HardLaunch\EXE\Backups\HardWU24.exe "%cd%"\HardLaunch\VS\U24\Patches\GodHangarSpawn.xdelta "%cd%"\HardLaunch\VS\U24\HardWU24.exe
ECHO Apply God Hangar Spawn patch to HardWU24.exe (U2.04) - Done!
@echo off
timeout /t 5
goto mods
...
copy "%cd%"\HardLaunch\VS\B31\HardWB31.exe "%cd%"\HardLaunch\EXE\Backups\HardWB31.exe
del "%cd%"\HardLaunch\VS\B31\HardWB31.exe
"%cd%"\HardLaunch\#Dependencies\xdelta3.exe -d -s "%cd%"\HardLaunch\EXE\Backups\HardWB31.exe "%cd%"\HardLaunch\VS\B31\Patches\GodHangarSpawn.xdelta "%cd%"\HardLaunch\VS\B31\HardWB31.exe
ECHO Apply God Hangar Spawn patch to HardWB31.exe (U3.00b1) - Done!
@echo off
timeout /t 5
goto mods
...
copy "%cd%"\HardLaunch\VS\B32\HardWB32.exe "%cd%"\HardLaunch\EXE\Backups\HardWB32.exe
del "%cd%"\HardLaunch\VS\B32\HardWB32.exe
"%cd%"\HardLaunch\#Dependencies\xdelta3.exe -d -s "%cd%"\HardLaunch\EXE\Backups\HardWB32.exe "%cd%"\HardLaunch\VS\B32\Patches\GodHangarSpawn.xdelta "%cd%"\HardLaunch\VS\B32\HardWB32.exe
ECHO Apply God Hangar Spawn patch to HardWB32.exe (U3.00b2) - Done!
@echo off
timeout /t 5
goto mods
...
copy "%cd%"\HardLaunch\VS\B33\HardWB33.exe "%cd%"\HardLaunch\EXE\Backups\HardWB33.exe
del "%cd%"\HardLaunch\VS\B33\HardWB33.exe
"%cd%"\HardLaunch\#Dependencies\xdelta3.exe -d -s "%cd%"\HardLaunch\EXE\Backups\HardWB33.exe "%cd%"\HardLaunch\VS\B33\Patches\GodHangarSpawn.xdelta "%cd%"\HardLaunch\VS\B33\HardWB33.exe
ECHO Apply God Hangar Spawn patch to HardWB33.exe (U3.00b3) - Done!
@echo off
timeout /t 5
goto mods
...
copy "%cd%"\HardLaunch\VS\B34\HardWB34.exe "%cd%"\HardLaunch\EXE\Backups\HardWB34.exe
del "%cd%"\HardLaunch\VS\B34\HardWB34.exe
"%cd%"\HardLaunch\#Dependencies\xdelta3.exe -d -s "%cd%"\HardLaunch\EXE\Backups\HardWB34.exe "%cd%"\HardLaunch\VS\B34\Patches\GodHangarSpawn.xdelta "%cd%"\HardLaunch\VS\B34\HardWB34.exe
ECHO Apply God Hangar Spawn patch to HardWB34.exe (U3.00b4) - Done!
@echo off
timeout /t 5
goto mods
...
copy "%cd%"\HardLaunch\VS\B35\HardWB35.exe "%cd%"\HardLaunch\EXE\Backups\HardWB35.exe
del "%cd%"\HardLaunch\VS\B35\HardWB35.exe
"%cd%"\HardLaunch\#Dependencies\xdelta3.exe -d -s "%cd%"\HardLaunch\EXE\Backups\HardWB35.exe "%cd%"\HardLaunch\VS\B35\Patches\GodHangarSpawn.xdelta "%cd%"\HardLaunch\VS\B35\HardWB35.exe
ECHO Apply God Hangar Spawn patch to HardWB35.exe (U3.00b5) - Done!
@echo off
timeout /t 5
goto mods
...
copy "%cd%"\HardLaunch\VS\UM1\HardWUM1.exe "%cd%"\HardLaunch\EXE\Backups\HardWUM1.exe
del "%cd%"\HardLaunch\VS\UM1\HardWUM1.exe
"%cd%"\HardLaunch\#Dependencies\xdelta3.exe -d -s "%cd%"\HardLaunch\EXE\Backups\HardWUM1.exe "%cd%"\HardLaunch\VS\UM1\Patches\GodHangarSpawn.xdelta "%cd%"\HardLaunch\VS\UM1\HardWUM1.exe
ECHO Apply God Hangar Spawn patch to HardWUM1.exe (UIM.01) - Done!
@echo off
timeout /t 5
goto mods
...
copy "%cd%"\HardLaunch\VS\UM2\HardWUM2.exe "%cd%"\HardLaunch\EXE\Backups\HardWUM2.exe
del "%cd%"\HardLaunch\VS\UM2\HardWUM2.exe
"%cd%"\HardLaunch\#Dependencies\xdelta3.exe -d -s "%cd%"\HardLaunch\EXE\Backups\HardWUM2.exe "%cd%"\HardLaunch\VS\UM2\Patches\GodHangarSpawn.xdelta "%cd%"\HardLaunch\VS\UM2\HardWUM2.exe
ECHO Apply God Hangar Spawn patch to HardWUM2.exe (UIM.02) - Done!
@echo off
timeout /t 5
goto mods
...
copy "%cd%"\HardLaunch\VS\U21\HardWU21.exe "%cd%"\HardLaunch\EXE\Backups\HardWU21.exe
del "%cd%"\HardLaunch\VS\U21\HardWU21.exe
"%cd%"\HardLaunch\#Dependencies\xdelta3.exe -d -s "%cd%"\HardLaunch\EXE\Backups\HardWU21.exe "%cd%"\HardLaunch\VS\U21\Patches\GodHangarSpawn.xdelta "%cd%"\HardLaunch\VS\U21\HardWU21.exe
ECHO Apply God Hangar Spawn patch to HardWU21.exe (UIM.02.01) - Done!
@echo off
timeout /t 5
goto mods
...
copy "%cd%"\HardLaunch\VS\UM3\HardWUM3.exe "%cd%"\HardLaunch\EXE\Backups\HardWUM3.exe
del "%cd%"\HardLaunch\VS\UM3\HardWUM3.exe
"%cd%"\HardLaunch\#Dependencies\xdelta3.exe -d -s "%cd%"\HardLaunch\EXE\Backups\HardWUM3.exe "%cd%"\HardLaunch\VS\UM3\Patches\GodHangarSpawn.xdelta "%cd%"\HardLaunch\VS\UM3\HardWUM3.exe
ECHO Apply God Hangar Spawn patch to HardWUM3.exe (UIM.03) - Done!
@echo off
timeout /t 5
goto mods
...
copy "%cd%"\HardLaunch\VS\UM4\HardWUM4.exe "%cd%"\HardLaunch\EXE\Backups\HardWUM4.exe
del "%cd%"\HardLaunch\VS\UM4\HardWUM4.exe
"%cd%"\HardLaunch\#Dependencies\xdelta3.exe -d -s "%cd%"\HardLaunch\EXE\Backups\HardWUM4.exe "%cd%"\HardLaunch\VS\UM4\Patches\GodHangarSpawn.xdelta "%cd%"\HardLaunch\VS\UM4\HardWUM4.exe
ECHO Apply God Hangar Spawn patch to HardWUM4.exe (UIM.04) - Done!
@echo off
timeout /t 5
goto mods
...
copy "%cd%"\HardLaunch\VS\UM5\HardWUM5.exe "%cd%"\HardLaunch\EXE\Backups\HardWUM5.exe
del "%cd%"\HardLaunch\VS\UM5\HardWUM5.exe
"%cd%"\HardLaunch\#Dependencies\xdelta3.exe -d -s "%cd%"\HardLaunch\EXE\Backups\HardWUM5.exe "%cd%"\HardLaunch\VS\UM5\Patches\GodHangarSpawn.xdelta "%cd%"\HardLaunch\VS\UM5\HardWUM5.exe
ECHO Apply God Hangar Spawn patch to HardWUM5.exe (UIM.05) - Done!
@echo off
timeout /t 5
goto mods
...
timeout /t 5
goto mods
:godhangarspawnremovalF20
@echo off
set "currentDirectory=%cd%"
@echo off
del "%cd%"\HardLaunch\VS\F20\HardWF20.exe
copy "%cd%"\HardLaunch\EXE\Backups\HardWF20.exe "%cd%"\HardLaunch\VS\F20\HardWF20.exe
ECHO Remove God Hangar Spawn patch from HardWF20.exe (F2.0) - Done!
@echo off
timeout /t 5
goto mods
:godhangarspawnremovalF21
@echo off
set "currentDirectory=%cd%"
@echo off
del "%cd%"\HardLaunch\VS\F21\HardWF21.exe
copy "%cd%"\HardLaunch\EXE\Backups\HardWF21.exe "%cd%"\HardLaunch\VS\F21\HardWF21.exe
ECHO Remove God Hangar Spawn patch from HardWF21.exe (F2.1) - Done!
@echo off
timeout /t 5
goto mods
:godhangarspawnremovalU24
@echo off
set "currentDirectory=%cd%"
@echo off
del "%cd%"\HardLaunch\VS\U24\HardWU24.exe
copy "%cd%"\HardLaunch\EXE\Backups\HardWU24.exe "%cd%"\HardLaunch\VS\U24\HardWU24.exe
ECHO Remove God Hangar Spawn patch from HardWU24.exe (U2.04) - Done!
@echo off
timeout /t 5
goto mods
:godhangarspawnremovalB31
@echo off
set "currentDirectory=%cd%"
@echo off
del "%cd%"\HardLaunch\VS\B31\HardWB31.exe
copy "%cd%"\HardLaunch\EXE\Backups\HardWB31.exe "%cd%"\HardLaunch\VS\B31\HardWB31.exe
ECHO Remove God Hangar Spawn patch from HardWB31.exe (U3.00b1) - Done!
@echo off
timeout /t 5
goto mods
:godhangarspawnremovalB32
@echo off
set "currentDirectory=%cd%"
@echo off
del "%cd%"\HardLaunch\VS\B32\HardWB32.exe
copy "%cd%"\HardLaunch\EXE\Backups\HardWB32.exe "%cd%"\HardLaunch\VS\B32\HardWB32.exe
ECHO Remove God Hangar Spawn patch from HardWB32.exe (U3.00b2) - Done!
@echo off
timeout /t 5
goto mods
:godhangarspawnremovalB33
@echo off
set "currentDirectory=%cd%"
@echo off
del "%cd%"\HardLaunch\VS\B33\HardWB33.exe
copy "%cd%"\HardLaunch\EXE\Backups\HardWB33.exe "%cd%"\HardLaunch\VS\B33\HardWB33.exe
ECHO Remove God Hangar Spawn patch from HardWB33.exe (U3.00b3) - Done!
@echo off
timeout /t 5
goto mods
:godhangarspawnremovalB34
@echo off
set "currentDirectory=%cd%"
@echo off
del "%cd%"\HardLaunch\VS\B34\HardWB34.exe
copy "%cd%"\HardLaunch\EXE\Backups\HardWB34.exe "%cd%"\HardLaunch\VS\B34\HardWB34.exe
ECHO Remove God Hangar Spawn patch from HardWB34.exe (U3.00b4) - Done!
@echo off
timeout /t 5
goto mods
:godhangarspawnremovalB35
@echo off
set "currentDirectory=%cd%"
@echo off
del "%cd%"\HardLaunch\VS\B35\HardWB35.exe
copy "%cd%"\HardLaunch\EXE\Backups\HardWB35.exe "%cd%"\HardLaunch\VS\B35\HardWB35.exe
ECHO Remove God Hangar Spawn patch from HardWB35.exe (U3.00b5) - Done!
@echo off
timeout /t 5
goto mods
:godhangarspawnremovalUM1
@echo off
set "currentDirectory=%cd%"
@echo off
del "%cd%"\HardLaunch\VS\UM1\HardWUM1.exe
copy "%cd%"\HardLaunch\EXE\Backups\HardWUM1.exe "%cd%"\HardLaunch\VS\UM1\HardWUM1.exe
ECHO Remove God Hangar Spawn patch from HardWUM1.exe (UIM.01) - Done!
@echo off
timeout /t 5
goto mods
:godhangarspawnremovalUM2
@echo off
set "currentDirectory=%cd%"
@echo off
del "%cd%"\HardLaunch\VS\UM2\HardWUM2.exe
copy "%cd%"\HardLaunch\EXE\Backups\HardWUM2.exe "%cd%"\HardLaunch\VS\UM2\HardWUM2.exe
ECHO Remove God Hangar Spawn patch from HardWUM2.exe (UIM.02) - Done!
@echo off
timeout /t 5
goto mods
:godhangarspawnremovalU21
@echo off
set "currentDirectory=%cd%"
@echo off
del "%cd%"\HardLaunch\VS\U21\HardWU21.exe
copy "%cd%"\HardLaunch\EXE\Backups\HardWU21.exe "%cd%"\HardLaunch\VS\U21\HardWU21.exe
ECHO Remove God Hangar Spawn patch from HardWU21.exe (UIM.02.01) - Done!
@echo off
timeout /t 5
goto mods
:godhangarspawnremovalUM3
@echo off
set "currentDirectory=%cd%"
@echo off
del "%cd%"\HardLaunch\VS\UM3\HardWUM3.exe
copy "%cd%"\HardLaunch\EXE\Backups\HardWUM3.exe "%cd%"\HardLaunch\VS\UM3\HardWUM3.exe
ECHO Remove God Hangar Spawn patch from HardWUM3.exe (UIM.03) - Done!
@echo off
timeout /t 5
goto mods
:godhangarspawnremovalUM4
@echo off
set "currentDirectory=%cd%"
@echo off
del "%cd%"\HardLaunch\VS\UM4\HardWUM4.exe
copy "%cd%"\HardLaunch\EXE\Backups\HardWUM4.exe "%cd%"\HardLaunch\VS\UM4\HardWUM4.exe
ECHO Remove God Hangar Spawn patch from HardWUM4.exe (UIM.04) - Done!
@echo off
timeout /t 5
goto mods
:godhangarspawnremovalUM5
@echo off
set "currentDirectory=%cd%"
@echo off
del "%cd%"\HardLaunch\VS\UM5\HardWUM5.exe
copy "%cd%"\HardLaunch\EXE\Backups\HardWUM5.exe "%cd%"\HardLaunch\VS\UM5\HardWUM5.exe
ECHO Remove God Hangar Spawn patch from HardWUM5.exe (UIM.05) - Done!
@echo off
timeout /t 5
goto mods
...
copy "%cd%"\HardLaunch\VS\B31\HardWB31.exe "%cd%"\HardLaunch\EXE\Backups\HardWB31.exe
del "%cd%"\HardLaunch\VS\B31\HardWB31.exe
"%cd%"\HardLaunch\#Dependencies\xdelta3.exe -d -s "%cd%"\HardLaunch\EXE\Backups\HardWB31.exe "%cd%"\HardLaunch\VS\B31\Patches\AAGHCombo.xdelta "%cd%"\HardLaunch\VS\B31\HardWB31.exe
ECHO Apply Combo patch to HardWB31.exe (U3.00b1) - Done!
@echo off
timeout /t 5
goto mods
:comboB32
...
copy "%cd%"\HardLaunch\VS\B32\HardWB32.exe "%cd%"\HardLaunch\EXE\Backups\HardWB32.exe
del "%cd%"\HardLaunch\VS\B32\HardWB32.exe
"%cd%"\HardLaunch\#Dependencies\xdelta3.exe -d -s "%cd%"\HardLaunch\EXE\Backups\HardWB32.exe "%cd%"\HardLaunch\VS\B32\Patches\AAGHCombo.xdelta "%cd%"\HardLaunch\VS\B32\HardWB32.exe
ECHO Apply Combo patch to HardWB32.exe (U3.00b2) - Done!
@echo off
timeout /t 5
goto mods
:comboB33
...
copy "%cd%"\HardLaunch\VS\B33\HardWB33.exe "%cd%"\HardLaunch\EXE\Backups\HardWB33.exe
del "%cd%"\HardLaunch\VS\B33\HardWB33.exe
"%cd%"\HardLaunch\#Dependencies\xdelta3.exe -d -s "%cd%"\HardLaunch\EXE\Backups\HardWB33.exe "%cd%"\HardLaunch\VS\B33\Patches\AAGHCombo.xdelta "%cd%"\HardLaunch\VS\B33\HardWB33.exe
ECHO Apply Combo patch to HardWB33.exe (U3.00b3) - Done!
@echo off
timeout /t 5
goto mods
:comboB34
...
copy "%cd%"\HardLaunch\VS\B34\HardWB34.exe "%cd%"\HardLaunch\EXE\Backups\HardWB34.exe
del "%cd%"\HardLaunch\VS\B34\HardWB34.exe
"%cd%"\HardLaunch\#Dependencies\xdelta3.exe -d -s "%cd%"\HardLaunch\EXE\Backups\HardWB34.exe "%cd%"\HardLaunch\VS\B34\Patches\AAGHCombo.xdelta "%cd%"\HardLaunch\VS\B34\HardWB34.exe
ECHO Apply Combo patch to HardWB34.exe (U3.00b4) - Done!
@echo off
timeout /t 5
goto mods
:comboB35
...
copy "%cd%"\HardLaunch\VS\B35\HardWB35.exe "%cd%"\HardLaunch\EXE\Backups\HardWB35.exe
del "%cd%"\HardLaunch\VS\B35\HardWB35.exe
"%cd%"\HardLaunch\#Dependencies\xdelta3.exe -d -s "%cd%"\HardLaunch\EXE\Backups\HardWB35.exe "%cd%"\HardLaunch\VS\B35\Patches\AAGHCombo.xdelta "%cd%"\HardLaunch\VS\B35\HardWB35.exe
ECHO Apply Combo patch to HardWB35.exe (U3.00b5) - Done!
@echo off
timeout /t 5
goto mods
:comboUM1
...
copy "%cd%"\HardLaunch\VS\UM1\HardWUM1.exe "%cd%"\HardLaunch\EXE\Backups\HardWUM1.exe
del "%cd%"\HardLaunch\VS\UM1\HardWUM1.exe
"%cd%"\HardLaunch\#Dependencies\xdelta3.exe -d -s "%cd%"\HardLaunch\EXE\Backups\HardWUM1.exe "%cd%"\HardLaunch\VS\UM1\Patches\AAGHCombo.xdelta "%cd%"\HardLaunch\VS\UM1\HardWUM1.exe
ECHO Apply Combo patch to HardWUM1.exe (UIM.01) - Done!
@echo off
timeout /t 5
goto mods
:comboUM2
...
copy "%cd%"\HardLaunch\VS\UM2\HardWUM2.exe "%cd%"\HardLaunch\EXE\Backups\HardWUM2.exe
del "%cd%"\HardLaunch\VS\UM2\HardWUM2.exe
"%cd%"\HardLaunch\#Dependencies\xdelta3.exe -d -s "%cd%"\HardLaunch\EXE\Backups\HardWUM2.exe "%cd%"\HardLaunch\VS\UM2\Patches\AAGHCombo.xdelta "%cd%"\HardLaunch\VS\UM2\HardWUM2.exe
ECHO Apply Combo patch to HardWUM2.exe (UIM.02) - Done!
@echo off
timeout /t 5
goto mods
:comboU21
...
copy "%cd%"\HardLaunch\VS\U21\HardWU21.exe "%cd%"\HardLaunch\EXE\Backups\HardWU21.exe
del "%cd%"\HardLaunch\VS\U21\HardWU21.exe
"%cd%"\HardLaunch\#Dependencies\xdelta3.exe -d -s "%cd%"\HardLaunch\EXE\Backups\HardWU21.exe "%cd%"\HardLaunch\VS\U21\Patches\AAGHCombo.xdelta "%cd%"\HardLaunch\VS\U21\HardWU21.exe
ECHO Apply Combo patch to HardWU21.exe (UIM.02.01) - Done!
@echo off
timeout /t 5
goto mods
:comboUM3
...
copy "%cd%"\HardLaunch\VS\UM3\HardWUM3.exe "%cd%"\HardLaunch\EXE\Backups\HardWUM3.exe
del "%cd%"\HardLaunch\VS\UM3\HardWUM3.exe
"%cd%"\HardLaunch\#Dependencies\xdelta3.exe -d -s "%cd%"\HardLaunch\EXE\Backups\HardWUM3.exe "%cd%"\HardLaunch\VS\UM3\Patches\AAGHCombo.xdelta "%cd%"\HardLaunch\VS\UM3\HardWUM3.exe
ECHO Apply Combo patch to HardWUM3.exe (UIM.03) - Done!
@echo off
timeout /t 5
goto mods
:comboUM4
...
copy "%cd%"\HardLaunch\VS\UM4\HardWUM4.exe "%cd%"\HardLaunch\EXE\Backups\HardWUM4.exe
del "%cd%"\HardLaunch\VS\UM4\HardWUM4.exe
"%cd%"\HardLaunch\#Dependencies\xdelta3.exe -d -s "%cd%"\HardLaunch\EXE\Backups\HardWUM4.exe "%cd%"\HardLaunch\VS\UM4\Patches\AAGHCombo.xdelta "%cd%"\HardLaunch\VS\UM4\HardWUM4.exe
ECHO Apply Combo patch to HardWUM4.exe (UIM.04) - Done!
@echo off
timeout /t 5
goto mods
:comboUM5
...
copy "%cd%"\HardLaunch\VS\UM5\HardWUM5.exe "%cd%"\HardLaunch\EXE\Backups\HardWUM5.exe
del "%cd%"\HardLaunch\VS\UM5\HardWUM5.exe
"%cd%"\HardLaunch\#Dependencies\xdelta3.exe -d -s "%cd%"\HardLaunch\EXE\Backups\HardWUM5.exe "%cd%"\HardLaunch\VS\UM5\Patches\AAGHCombo.xdelta "%cd%"\HardLaunch\VS\UM5\HardWUM5.exe
ECHO Apply Combo patch to HardWUM5.exe (UIM.05) - Done!
@echo off
timeout /t 5
goto mods
:comboUM6
...
@echo off
del HardwarW.exe
"%cd%"\HardLaunch\#Dependencies\xdelta3.exe -d -s "%cd%"\HardLaunch\EXE\Backups\HardwarWUIM06.exe "%cd%"\HardLaunch\EXE\Patches\AAGHCombo.xdelta "%cd%"\HardwarW.exe
ECHO Apply Combo patch to HardwarW.exe (UIM.06) - Done!
ECHO Remember that this will break the version switcher until reverted...
@echo off
timeout /t 10
goto mods

REM -----------------------------Combo Patches Removal---------------------------------------------
...
del "%cd%"\HardLaunch\VS\B31\HardWB31.exe
copy "%cd%"\HardLaunch\EXE\Backups\HardWB31.exe "%cd%"\HardLaunch\VS\B31\HardWB31.exe
ECHO Remove Combo patch from HardWB31.exe (U3.00b1) - Done!
@echo off
timeout /t 5
goto mods
:comboremovalB32
...
del "%cd%"\HardLaunch\VS\B32\HardWB32.exe
copy "%cd%"\HardLaunch\EXE\Backups\HardWB32.exe "%cd%"\HardLaunch\VS\B32\HardWB32.exe
ECHO Remove Combo patch from HardWB32.exe (U3.00b2) - Done!
@echo off
timeout /t 5
goto mods
:comboremovalB33
...
del "%cd%"\HardLaunch\VS\B33\HardWB33.exe
copy "%cd%"\HardLaunch\EXE\Backups\HardWB33.exe "%cd%"\HardLaunch\VS\B33\HardWB33.exe
ECHO Remove Combo patch from HardWB33.exe (U3.00b3) - Done!
@echo off
timeout /t 5
goto mods
:comboremovalB34
...
del "%cd%"\HardLaunch\VS\B34\HardWB34.exe
copy "%cd%"\HardLaunch\EXE\Backups\HardWB34.exe "%cd%"\HardLaunch\VS\B34\HardWB34.exe
ECHO Remove Combo patch from HardWB34.exe (U3.00b4) - Done!
@echo off
timeout /t 5
goto mods
:comboremovalB35
...
del "%cd%"\HardLaunch\VS\B35\HardWB35.exe
copy "%cd%"\HardLaunch\EXE\Backups\HardWB35.exe "%cd%"\HardLaunch\VS\B35\HardWB35.exe
ECHO Remove Combo patch from HardWB35.exe (U3.00b5) - Done!
@echo off
timeout /t 5
goto mods
:comboremovalUM1
...
del "%cd%"\HardLaunch\VS\UM1\HardWUM1.exe
copy "%cd%"\HardLaunch\EXE\Backups\HardWUM1.exe "%cd%"\HardLaunch\VS\UM1\HardWUM1.exe
ECHO Remove Combo patch from HardWUM1.exe (UIM.01) - Done!
@echo off
timeout /t 5
goto mods
:comboremovalUM2
...
del "%cd%"\HardLaunch\VS\UM2\HardWUM2.exe
copy "%cd%"\HardLaunch\EXE\Backups\HardWUM2.exe "%cd%"\HardLaunch\VS\UM2\HardWUM2.exe
ECHO Remove Combo patch from HardWUM2.exe (UIM.02) - Done!
@echo off
timeout /t 5
goto mods
:comboremovalU21
...
del "%cd%"\HardLaunch\VS\U21\HardWU21.exe
copy "%cd%"\HardLaunch\EXE\Backups\HardWU21.exe "%cd%"\HardLaunch\VS\U21\HardWU21.exe
ECHO Remove Combo patch from HardWU21.exe (UIM.02.01) - Done!
@echo off
timeout /t 5
goto mods
:comboremovalUM3
...
del "%cd%"\HardLaunch\VS\UM3\HardWUM3.exe
copy "%cd%"\HardLaunch\EXE\Backups\HardWUM3.exe "%cd%"\HardLaunch\VS\UM3\HardWUM3.exe
ECHO Remove Combo patch from HardWUM3.exe (UIM.03) - Done!
@echo off
timeout /t 5
goto mods
:comboremovalUM4
...
del "%cd%"\HardLaunch\VS\UM4\HardWUM4.exe
copy "%cd%"\HardLaunch\EXE\Backups\HardWUM4.exe "%cd%"\HardLaunch\VS\UM4\HardWUM4.exe
ECHO Remove Combo patch from HardWUM4.exe (UIM.04) - Done!
@echo off
timeout /t 5
goto mods
:comboremovalUM5
...
del "%cd%"\HardLaunch\VS\UM5\HardWUM5.exe
copy "%cd%"\HardLaunch\EXE\Backups\HardWUM5.exe "%cd%"\HardLaunch\VS\UM5\HardWUM5.exe
ECHO Remove Combo patch from HardWUM5.exe (UIM.05) - Done!
@echo off
timeout /t 5
goto mods
:comboremovalUM6
...
del HardwarW.exe
copy "%cd%"\HardLaunch\EXE\Backups\HardwarW.exe "%cd%"\HardwarW.exe
ECHO Remove Combo patch from HardwarW.exe (UIM.06) - Done!
ECHO Remember that this will break the version switcher until reverted...
@echo off
timeout /t 10
goto mods
...
ECHO ----------------------------------------------------------------------------------------------
ECHO 1.  Run Hardwar DOS Demo
ECHO 2.  Run Hardwar Demo - ver. D1.6
ECHO ----------------------------------------------------------------------------------------------
ECHO 3.  Run Hardwar - ver. F1.2 (German)
ECHO 4.  Run Hardwar - ver. F2.0
ECHO 5.  Run Hardwar - ver. F2.1
ECHO 6.  Run Hardwar - ver. U1.00 - Rendering issues, unplayable (D3 - Missing a Z buffer)
ECHO 7.  Run Hardwar - ver. U2.01 - Lost to time...
ECHO 8.  Run Hardwar - ver. U2.02 - Lost to time...
ECHO 9.  Run Hardwar - ver. U2.03 - Lost to time...
ECHO 10. Run Hardwar - ver. U2.04
ECHO ----------------------------------------------------------------------------------------------
ECHO 11. Run Hardwar - ver. U3.00b1
ECHO 12. Run Hardwar - ver. U3.00b2
ECHO 13. Run Hardwar - ver. U3.00b3
ECHO 14. Run Hardwar - ver. U3.00b4
ECHO 15. Run Hardwar - ver. U3.00b5
ECHO ----------------------------------------------------------------------------------------------
ECHO 16. Run Hardwar - ver. UIM.01
ECHO 17. Run Hardwar - ver. UIM.02
ECHO 18. Run Hardwar - ver. UIM.02.01
ECHO 19. Run Hardwar - ver. UIM.03
ECHO 20. Run Hardwar - ver. UIM.04
ECHO 21. Run Hardwar - ver. UIM.05
ECHO ----------------------------------------------------------------------------------------------
ECHO 22. Run Hardwar Enhanced - ver. UIM.06
ECHO ----------------------------------------------------------------------------------------------
ECHO 23. Back to Main Menu
ECHO ----------------------------------------------------------------------------------------------
SET /P vs=Type the number of your selection: 
if %vs%==1 goto demodos
if %vs%==2 goto demo16
if %vs%==3 goto f12
if %vs%==4 goto f20
if %vs%==5 goto f21
if %vs%==6 goto u10
if %vs%==7 goto u21lost
if %vs%==8 goto u22lost
if %vs%==9 goto u23lost
if %vs%==10 goto u24
if %vs%==11 goto b31
if %vs%==12 goto b32
if %vs%==13 goto b33
...
:u21lost
ECHO Unfortunately U2.01 has been lost to time... let me know if you find it! - Bladez1992#3813 (Discord)
@echo off
timeout /t 10
goto version_switcher
:u22lost
ECHO Unfortunately U2.02 has been lost to time... let me know if you find it! - Bladez1992#3813 (Discord)
@echo off
timeout /t 10
goto version_switcher
:u23lost
ECHO Unfortunately U2.03 has been lost to time... let me know if you find it! - Bladez1992#3813 (Discord)
@echo off
timeout /t 10
goto version_switcher
...
:demodos
@echo off
start "" /D"%~dp0HardLaunch\VS\DemoDOS" "DOSBox.exe" "%~dp0HardLaunch\VS\DemoDOS\HARDWAR.EXE" -exit -conf "%~dp0HardLaunch\VS\DemoDOS\DOSBoxGameConfigFile.conf" -noconsole 
goto main_menu
...
REG ADD HKEY_CURRENT_USER\SOFTWARE\Refinery\HardDem\Config /v KamFong /t REG_SZ /d ChinHo /f
...
@echo off
set "currentDirectory=%cd%"
regedit /s "%~dp0\HardLaunch\VS\F12\f12.reg"
xcopy "%cd%"\Music "%cd%"\HardLaunch\VS\F12\Music /E /Y /I
xcopy "%cd%"\HardLaunch\BF "%cd%"\HardLaunch\VS\F12\BF /E /Y /I
REG ADD HKEY_CURRENT_USER\SOFTWARE\Refinery\HmanF12\Config /v DataPath /t REG_SZ /d "%cd%"\HardLaunch\VS\F12\ /f
REG ADD HKEY_CURRENT_USER\SOFTWARE\Refinery\HmanF12\Config /v DataPath2 /t REG_SZ /d "%cd%"\HardLaunch\VS\F12\ /f
REG ADD HKEY_CURRENT_USER\SOFTWARE\Refinery\HmanF12\Config /v GDVPath /t REG_SZ /d "%cd%"\HardLaunch\VS\F12\GDV\ /f
REG ADD HKEY_CURRENT_USER\SOFTWARE\Refinery\HmanF12\Config /v GDVPath2 /t REG_SZ /d "%cd%"\HardLaunch\VS\F12\GDV\ /f
REG ADD HKEY_CURRENT_USER\SOFTWARE\Refinery\HmanF12\Config /v GDVPath3 /t REG_SZ /d "%cd%"\HardLaunch\VS\F12\GDV\ /f
REG ADD HKEY_CURRENT_USER\SOFTWARE\Refinery\HmanF12\Config /v RunPath /t REG_SZ /d "%cd%"\HardLaunch\VS\F12\ /f
REG ADD HKEY_CURRENT_USER\SOFTWARE\Refinery\HmanF12\Config /v SavePath /t REG_SZ /d "%cd%"\HardLaunch\VS\F12\Savegames\ /f
REG ADD HKEY_CURRENT_USER\SOFTWARE\Refinery\HmanF12\Config /v SourcePath /t REG_SZ /d "%cd%"\HardLaunch\VS\F12\ /f
REG ADD HKEY_CURRENT_USER\SOFTWARE\Refinery\HmanF12\Config /v KamFong /t REG_SZ /d ChinHo /f
copy "%cd%"\DATA\Hardwar.res "%cd%"\HardLaunch\VS\F12\HardF12.res
set "currentDirectory=%cd%"
copy "%cd%"\HardLaunch\RES\Backups\HardwarUIM06.res "%cd%"\HardLaunch\VS\F12\HardF12.res
copy "%cd%"\HardLaunch\#Dependencies\dgVoodooCpl.exe "%cd%"\HardLaunch\VS\F12\dgVoodooCpl.exe
copy "%cd%"\HardLaunch\#Dependencies\dgVoodoo.conf "%cd%"\HardLaunch\VS\F12\dgVoodoo.conf
copy "%cd%"\HardLaunch\#Dependencies\DDraw.dll "%cd%"\HardLaunch\VS\F12\DDraw.dll
copy "%cd%"\HardLaunch\#Dependencies\D3DImm.dll "%cd%"\HardLaunch\VS\F12\D3DImm.dll
copy "%cd%"\HardLaunch\#Dependencies\D3D9.dll "%cd%"\HardLaunch\VS\F12\D3D9.dll
copy "%cd%"\HardLaunch\#Dependencies\D3D8.dll "%cd%"\HardLaunch\VS\F12\D3D8.dll
copy DSetup.DLL "%cd%"\HardLaunch\VS\F12\DSetup.DLL
copy libogg-0.dll "%cd%"\HardLaunch\VS\F12\libogg-0.dll
copy libvorbis-0.dll "%cd%"\HardLaunch\VS\F12\libvorbis-0.dll
copy libvorbisfile-3.dll "%cd%"\HardLaunch\VS\F12\libvorbisfile-3.dll
copy winmm.dll "%cd%"\HardLaunch\VS\F12\winmm.dll
"%cd%"\HardLaunch\#Dependencies\xdelta3.exe -d -s "%cd%"\HardLaunch\EXE\Backups\HardwarWUIM06.exe "%cd%"\HardLaunch\VS\F12\Patches\HWW_UIM06toF12.xdelta "%cd%"\HardLaunch\VS\F12\HardWF12.exe
"%cd%"\HardLaunch\#Dependencies\xdelta3.exe -d -s "%cd%"\HardLaunch\EXE\Backups\HardmanUIM06.exe "%cd%"\HardLaunch\VS\F12\Patches\HMAN_UIM06toF12.xdelta "%cd%"\HardLaunch\VS\F12\HmanF12.exe
cd /D "%cd%"\HardLaunch\VS\F12 && HardLaunchF12.bat
@echo off
goto end
...
xcopy "%cd%"\Music "%cd%"\HardLaunch\VS\F20\Music /E /Y /I
xcopy "%cd%"\HardLaunch\BF "%cd%"\HardLaunch\VS\F20\BF /E /Y /I
...
REG ADD HKEY_CURRENT_USER\SOFTWARE\Refinery\HmanF20\Config /v KamFong /t REG_SZ /d ChinHo /f
...
copy libogg-0.dll "%cd%"\HardLaunch\VS\F20\libogg-0.dll
copy libvorbis-0.dll "%cd%"\HardLaunch\VS\F20\libvorbis-0.dll
copy libvorbisfile-3.dll "%cd%"\HardLaunch\VS\F20\libvorbisfile-3.dll
copy winmm.dll "%cd%"\HardLaunch\VS\F20\winmm.dll
...
xcopy "%cd%"\Music "%cd%"\HardLaunch\VS\F21\Music /E /Y /I
xcopy "%cd%"\HardLaunch\BF "%cd%"\HardLaunch\VS\F21\BF /E /Y /I
...
REG ADD HKEY_CURRENT_USER\SOFTWARE\Refinery\HmanF21\Config /v KamFong /t REG_SZ /d ChinHo /f
...
copy libogg-0.dll "%cd%"\HardLaunch\VS\F21\libogg-0.dll
copy libvorbis-0.dll "%cd%"\HardLaunch\VS\F21\libvorbis-0.dll
copy libvorbisfile-3.dll "%cd%"\HardLaunch\VS\F21\libvorbisfile-3.dll
copy winmm.dll "%cd%"\HardLaunch\VS\F21\winmm.dll
...
@echo off
set "currentDirectory=%cd%"
regedit /s "%~dp0\HardLaunch\VS\U10\u10.reg"
xcopy "%cd%"\Music "%cd%"\HardLaunch\VS\U10\Music /E /Y /I
xcopy "%cd%"\HardLaunch\BF "%cd%"\HardLaunch\VS\U10\BF /E /Y /I
REG ADD HKEY_CURRENT_USER\SOFTWARE\Refinery\HmanU10\Config /v DataPath /t REG_SZ /d "%cd%"\HardLaunch\VS\U10\ /f
REG ADD HKEY_CURRENT_USER\SOFTWARE\Refinery\HmanU10\Config /v DataPath2 /t REG_SZ /d "%cd%"\HardLaunch\VS\U10\ /f
REG ADD HKEY_CURRENT_USER\SOFTWARE\Refinery\HmanU10\Config /v GDVPath /t REG_SZ /d "%cd%"\HardLaunch\VS\U10\GDV\ /f
REG ADD HKEY_CURRENT_USER\SOFTWARE\Refinery\HmanU10\Config /v GDVPath2 /t REG_SZ /d "%cd%"\HardLaunch\VS\U10\GDV\ /f
REG ADD HKEY_CURRENT_USER\SOFTWARE\Refinery\HmanU10\Config /v GDVPath3 /t REG_SZ /d "%cd%"\HardLaunch\VS\U10\GDV\ /f
REG ADD HKEY_CURRENT_USER\SOFTWARE\Refinery\HmanU10\Config /v RunPath /t REG_SZ /d "%cd%"\HardLaunch\VS\U10\ /f
REG ADD HKEY_CURRENT_USER\SOFTWARE\Refinery\HmanU10\Config /v SavePath /t REG_SZ /d "%cd%"\HardLaunch\VS\U10\Savegames\ /f
REG ADD HKEY_CURRENT_USER\SOFTWARE\Refinery\HmanU10\Config /v SourcePath /t REG_SZ /d "%cd%"\HardLaunch\VS\U10\ /f
REG ADD HKEY_CURRENT_USER\SOFTWARE\Refinery\HmanU10\Config /v KamFong /t REG_SZ /d ChinHo /f
set "currentDirectory=%cd%"
copy "%cd%"\HardLaunch\RES\Backups\HardwarUIM06.res "%cd%"\HardLaunch\VS\U10\HardU10.res
copy "%cd%"\HardLaunch\#Dependencies\dgVoodooCpl.exe "%cd%"\HardLaunch\VS\U10\dgVoodooCpl.exe
copy "%cd%"\HardLaunch\#Dependencies\dgVoodoo.conf "%cd%"\HardLaunch\VS\U10\dgVoodoo.conf
copy "%cd%"\HardLaunch\#Dependencies\DDraw.dll "%cd%"\HardLaunch\VS\U10\DDraw.dll
copy "%cd%"\HardLaunch\#Dependencies\D3DImm.dll "%cd%"\HardLaunch\VS\U10\D3DImm.dll
copy "%cd%"\HardLaunch\#Dependencies\D3D9.dll "%cd%"\HardLaunch\VS\U10\D3D9.dll
copy "%cd%"\HardLaunch\#Dependencies\D3D8.dll "%cd%"\HardLaunch\VS\U10\D3D8.dll
copy DSetup.DLL "%cd%"\HardLaunch\VS\U10\DSetup.DLL
copy libogg-0.dll "%cd%"\HardLaunch\VS\U10\libogg-0.dll
copy libvorbis-0.dll "%cd%"\HardLaunch\VS\U10\libvorbis-0.dll
copy libvorbisfile-3.dll "%cd%"\HardLaunch\VS\U10\libvorbisfile-3.dll
copy winmm.dll "%cd%"\HardLaunch\VS\U10\winmm.dll
"%cd%"\HardLaunch\#Dependencies\xdelta3.exe -d -s "%cd%"\HardLaunch\EXE\Backups\HardwarWUIM06.exe "%cd%"\HardLaunch\VS\U10\Patches\HWW_UIM06toU10.xdelta "%cd%"\HardLaunch\VS\U10\HardWU10.exe
"%cd%"\HardLaunch\#Dependencies\xdelta3.exe -d -s "%cd%"\HardLaunch\EXE\Backups\HardmanUIM06.exe "%cd%"\HardLaunch\VS\U10\Patches\HMAN_UIM06toU10.xdelta "%cd%"\HardLaunch\VS\U10\HmanU10.exe
"%cd%"\HardLaunch\#Dependencies\xdelta3.exe -d -s "%cd%"\HardLaunch\RES\Backups\HardwarUIM06.res "%cd%"\HardLaunch\VS\U10\Patches\HWR_UIM06toU10.xdelta "%cd%"\HardLaunch\VS\U10\HardU10.res
"%cd%"\HardLaunch\#Dependencies\xdelta3.exe -d -s "%cd%"\HardLaunch\RES\Backups\HardupUIM06.res "%cd%"\HardLaunch\VS\U10\Patches\HUP_UIM06toU10.xdelta "%cd%"\HardLaunch\VS\U10\HupU10.res
cd /D "%cd%"\HardLaunch\VS\U10 && HardLaunchU10.bat
@echo off
goto end
...
xcopy "%cd%"\Music "%cd%"\HardLaunch\VS\U24\Music /E /Y /I
xcopy "%cd%"\HardLaunch\BF "%cd%"\HardLaunch\VS\U24\BF /E /Y /I
xcopy "%cd%"\Moth_Skins\Vanilla "%cd%"\HardLaunch\VS\U24\Moth_Skins\Vanilla /E /Y /I
REG ADD HKEY_CURRENT_USER\SOFTWARE\Refinery\HmanU24\Config /v Skin0 /t REG_SZ /d "%cd%"\HardLaunch\VS\U24\Moth_Skins\Vanilla\moth_moon.bmp /f
REG ADD HKEY_CURRENT_USER\SOFTWARE\Refinery\HmanU24\Config /v Skin1 /t REG_SZ /d "%cd%"\HardLaunch\VS\U24\Moth_Skins\Vanilla\moth_silver.bmp /f
REG ADD HKEY_CURRENT_USER\SOFTWARE\Refinery\HmanU24\Config /v Skin2 /t REG_SZ /d "%cd%"\HardLaunch\VS\U24\Moth_Skins\Vanilla\moth_neo.bmp /f
REG ADD HKEY_CURRENT_USER\SOFTWARE\Refinery\HmanU24\Config /v Skin3 /t REG_SZ /d "%cd%"\HardLaunch\VS\U24\Moth_Skins\Vanilla\moth_hawk.bmp /f
REG ADD HKEY_CURRENT_USER\SOFTWARE\Refinery\HmanU24\Config /v Skin4 /t REG_SZ /d "%cd%"\HardLaunch\VS\U24\Moth_Skins\Vanilla\moth_death.bmp /f
REG ADD HKEY_CURRENT_USER\SOFTWARE\Refinery\HmanU24\Config /v Skin5 /t REG_SZ /d "%cd%"\HardLaunch\VS\U24\Moth_Skins\Vanilla\moth_police.bmp /f
REG ADD HKEY_CURRENT_USER\SOFTWARE\Refinery\HmanU24\Config /v Skin6 /t REG_SZ /d "%cd%"\HardLaunch\VS\U24\Moth_Skins\Vanilla\moth_swallow.bmp /f
REG ADD HKEY_CURRENT_USER\SOFTWARE\Refinery\HmanU24\Config /v SkinsOn /t REG_DWORD /d 0x00000000 /f
REG ADD HKEY_CURRENT_USER\SOFTWARE\Refinery\HmanU24\Config /v SkinDir /t REG_SZ /d "%cd%"\HardLaunch\VS\U24\Moth_Skins\ /f
...
REG ADD HKEY_CURRENT_USER\SOFTWARE\Refinery\HmanU24\Config /v KamFong /t REG_SZ /d ChinHo /f
...
copy libogg-0.dll "%cd%"\HardLaunch\VS\U24\libogg-0.dll
copy libvorbis-0.dll "%cd%"\HardLaunch\VS\U24\libvorbis-0.dll
copy libvorbisfile-3.dll "%cd%"\HardLaunch\VS\U24\libvorbisfile-3.dll
copy winmm.dll "%cd%"\HardLaunch\VS\U24\winmm.dll
...
xcopy "%cd%"\Music "%cd%"\HardLaunch\VS\B31\Music /E /Y /I
xcopy "%cd%"\HardLaunch\BF "%cd%"\HardLaunch\VS\B31\BF /E /Y /I
xcopy "%cd%"\Moth_Skins\Vanilla "%cd%"\HardLaunch\VS\B31\Moth_Skins\Vanilla /E /Y /I
REG ADD HKEY_CURRENT_USER\SOFTWARE\Refinery\HmanB31\Config /v Skin0 /t REG_SZ /d "%cd%"\HardLaunch\VS\B31\Moth_Skins\Vanilla\moth_moon.bmp /f
REG ADD HKEY_CURRENT_USER\SOFTWARE\Refinery\HmanB31\Config /v Skin1 /t REG_SZ /d "%cd%"\HardLaunch\VS\B31\Moth_Skins\Vanilla\moth_silver.bmp /f
REG ADD HKEY_CURRENT_USER\SOFTWARE\Refinery\HmanB31\Config /v Skin2 /t REG_SZ /d "%cd%"\HardLaunch\VS\B31\Moth_Skins\Vanilla\moth_neo.bmp /f
REG ADD HKEY_CURRENT_USER\SOFTWARE\Refinery\HmanB31\Config /v Skin3 /t REG_SZ /d "%cd%"\HardLaunch\VS\B31\Moth_Skins\Vanilla\moth_hawk.bmp /f
REG ADD HKEY_CURRENT_USER\SOFTWARE\Refinery\HmanB31\Config /v Skin4 /t REG_SZ /d "%cd%"\HardLaunch\VS\B31\Moth_Skins\Vanilla\moth_death.bmp /f
REG ADD HKEY_CURRENT_USER\SOFTWARE\Refinery\HmanB31\Config /v Skin5 /t REG_SZ /d "%cd%"\HardLaunch\VS\B31\Moth_Skins\Vanilla\moth_police.bmp /f
REG ADD HKEY_CURRENT_USER\SOFTWARE\Refinery\HmanB31\Config /v Skin6 /t REG_SZ /d "%cd%"\HardLaunch\VS\B31\Moth_Skins\Vanilla\moth_swallow.bmp /f
...
REG ADD HKEY_CURRENT_USER\SOFTWARE\Refinery\HmanB31\Config /v KamFong /t REG_SZ /d ChinHo /f
copy "%cd%"\HardLaunch\RES\Backups\HardupUIM06.res "%cd%"\HardLaunch\RES\Backups\HardupUIM06.res
...
copy libogg-0.dll "%cd%"\HardLaunch\VS\B31\libogg-0.dll
copy libvorbis-0.dll "%cd%"\HardLaunch\VS\B31\libvorbis-0.dll
copy libvorbisfile-3.dll "%cd%"\HardLaunch\VS\B31\libvorbisfile-3.dll
copy winmm.dll "%cd%"\HardLaunch\VS\B31\winmm.dll
...
xcopy "%cd%"\Music "%cd%"\HardLaunch\VS\B32\Music /E /Y /I
xcopy "%cd%"\HardLaunch\BF "%cd%"\HardLaunch\VS\B32\BF /E /Y /I
xcopy "%cd%"\Moth_Skins\Vanilla "%cd%"\HardLaunch\VS\B32\Moth_Skins\Vanilla /E /Y /I
REG ADD HKEY_CURRENT_USER\SOFTWARE\Refinery\HmanB32\Config /v Skin0 /t REG_SZ /d "%cd%"\HardLaunch\VS\B32\Moth_Skins\Vanilla\moth_moon.bmp /f
REG ADD HKEY_CURRENT_USER\SOFTWARE\Refinery\HmanB32\Config /v Skin1 /t REG_SZ /d "%cd%"\HardLaunch\VS\B32\Moth_Skins\Vanilla\moth_silver.bmp /f
REG ADD HKEY_CURRENT_USER\SOFTWARE\Refinery\HmanB32\Config /v Skin2 /t REG_SZ /d "%cd%"\HardLaunch\VS\B32\Moth_Skins\Vanilla\moth_neo.bmp /f
REG ADD HKEY_CURRENT_USER\SOFTWARE\Refinery\HmanB32\Config /v Skin3 /t REG_SZ /d "%cd%"\HardLaunch\VS\B32\Moth_Skins\Vanilla\moth_hawk.bmp /f
REG ADD HKEY_CURRENT_USER\SOFTWARE\Refinery\HmanB32\Config /v Skin4 /t REG_SZ /d "%cd%"\HardLaunch\VS\B32\Moth_Skins\Vanilla\moth_death.bmp /f
REG ADD HKEY_CURRENT_USER\SOFTWARE\Refinery\HmanB32\Config /v Skin5 /t REG_SZ /d "%cd%"\HardLaunch\VS\B32\Moth_Skins\Vanilla\moth_police.bmp /f
REG ADD HKEY_CURRENT_USER\SOFTWARE\Refinery\HmanB32\Config /v Skin6 /t REG_SZ /d "%cd%"\HardLaunch\VS\B32\Moth_Skins\Vanilla\moth_swallow.bmp /f
...
REG ADD HKEY_CURRENT_USER\SOFTWARE\Refinery\HmanB32\Config /v KamFong /t REG_SZ /d ChinHo /f
copy "%cd%"\HardLaunch\RES\Backups\HardupUIM06.res "%cd%"\HardLaunch\RES\Backups\HardupUIM06.res
...
copy libogg-0.dll "%cd%"\HardLaunch\VS\B32\libogg-0.dll
copy libvorbis-0.dll "%cd%"\HardLaunch\VS\B32\libvorbis-0.dll
copy libvorbisfile-3.dll "%cd%"\HardLaunch\VS\B32\libvorbisfile-3.dll
copy winmm.dll "%cd%"\HardLaunch\VS\B32\winmm.dll
...
xcopy "%cd%"\Music "%cd%"\HardLaunch\VS\B33\Music /E /Y /I
xcopy "%cd%"\HardLaunch\BF "%cd%"\HardLaunch\VS\B33\BF /E /Y /I
xcopy "%cd%"\Moth_Skins\Vanilla "%cd%"\HardLaunch\VS\B33\Moth_Skins\Vanilla /E /Y /I
REG ADD HKEY_CURRENT_USER\SOFTWARE\Refinery\HmanB33\Config /v Skin0 /t REG_SZ /d "%cd%"\HardLaunch\VS\B33\Moth_Skins\Vanilla\moth_moon.bmp /f
REG ADD HKEY_CURRENT_USER\SOFTWARE\Refinery\HmanB33\Config /v Skin1 /t REG_SZ /d "%cd%"\HardLaunch\VS\B33\Moth_Skins\Vanilla\moth_silver.bmp /f
REG ADD HKEY_CURRENT_USER\SOFTWARE\Refinery\HmanB33\Config /v Skin2 /t REG_SZ /d "%cd%"\HardLaunch\VS\B33\Moth_Skins\Vanilla\moth_neo.bmp /f
REG ADD HKEY_CURRENT_USER\SOFTWARE\Refinery\HmanB33\Config /v Skin3 /t REG_SZ /d "%cd%"\HardLaunch\VS\B33\Moth_Skins\Vanilla\moth_hawk.bmp /f
REG ADD HKEY_CURRENT_USER\SOFTWARE\Refinery\HmanB33\Config /v Skin4 /t REG_SZ /d "%cd%"\HardLaunch\VS\B33\Moth_Skins\Vanilla\moth_death.bmp /f
REG ADD HKEY_CURRENT_USER\SOFTWARE\Refinery\HmanB33\Config /v Skin5 /t REG_SZ /d "%cd%"\HardLaunch\VS\B33\Moth_Skins\Vanilla\moth_police.bmp /f
REG ADD HKEY_CURRENT_USER\SOFTWARE\Refinery\HmanB33\Config /v Skin6 /t REG_SZ /d "%cd%"\HardLaunch\VS\B33\Moth_Skins\Vanilla\moth_swallow.bmp /f
...
REG ADD HKEY_CURRENT_USER\SOFTWARE\Refinery\HmanB33\Config /v KamFong /t REG_SZ /d ChinHo /f
...
copy libogg-0.dll "%cd%"\HardLaunch\VS\B33\libogg-0.dll
copy libvorbis-0.dll "%cd%"\HardLaunch\VS\B33\libvorbis-0.dll
copy libvorbisfile-3.dll "%cd%"\HardLaunch\VS\B33\libvorbisfile-3.dll
copy winmm.dll "%cd%"\HardLaunch\VS\B33\winmm.dll
...
xcopy "%cd%"\Music "%cd%"\HardLaunch\VS\B34\Music /E /Y /I
xcopy "%cd%"\HardLaunch\BF "%cd%"\HardLaunch\VS\B34\BF /E /Y /I
xcopy "%cd%"\Moth_Skins\Vanilla "%cd%"\HardLaunch\VS\B34\Moth_Skins\Vanilla /E /Y /I
REG ADD HKEY_CURRENT_USER\SOFTWARE\Refinery\HmanB34\Config /v Skin0 /t REG_SZ /d "%cd%"\HardLaunch\VS\B34\Moth_Skins\Vanilla\moth_moon.bmp /f
REG ADD HKEY_CURRENT_USER\SOFTWARE\Refinery\HmanB34\Config /v Skin1 /t REG_SZ /d "%cd%"\HardLaunch\VS\B34\Moth_Skins\Vanilla\moth_silver.bmp /f
REG ADD HKEY_CURRENT_USER\SOFTWARE\Refinery\HmanB34\Config /v Skin2 /t REG_SZ /d "%cd%"\HardLaunch\VS\B34\Moth_Skins\Vanilla\moth_neo.bmp /f
REG ADD HKEY_CURRENT_USER\SOFTWARE\Refinery\HmanB34\Config /v Skin3 /t REG_SZ /d "%cd%"\HardLaunch\VS\B34\Moth_Skins\Vanilla\moth_hawk.bmp /f
REG ADD HKEY_CURRENT_USER\SOFTWARE\Refinery\HmanB34\Config /v Skin4 /t REG_SZ /d "%cd%"\HardLaunch\VS\B34\Moth_Skins\Vanilla\moth_death.bmp /f
REG ADD HKEY_CURRENT_USER\SOFTWARE\Refinery\HmanB34\Config /v Skin5 /t REG_SZ /d "%cd%"\HardLaunch\VS\B34\Moth_Skins\Vanilla\moth_police.bmp /f
REG ADD HKEY_CURRENT_USER\SOFTWARE\Refinery\HmanB34\Config /v Skin6 /t REG_SZ /d "%cd%"\HardLaunch\VS\B34\Moth_Skins\Vanilla\moth_swallow.bmp /f
...
REG ADD HKEY_CURRENT_USER\SOFTWARE\Refinery\HmanB34\Config /v KamFong /t REG_SZ /d ChinHo /f
...
copy libogg-0.dll "%cd%"\HardLaunch\VS\B34\libogg-0.dll
copy libvorbis-0.dll "%cd%"\HardLaunch\VS\B34\libvorbis-0.dll
copy libvorbisfile-3.dll "%cd%"\HardLaunch\VS\B34\libvorbisfile-3.dll
copy winmm.dll "%cd%"\HardLaunch\VS\B34\winmm.dll
...
xcopy "%cd%"\Music "%cd%"\HardLaunch\VS\B35\Music /E /Y /I
xcopy "%cd%"\HardLaunch\BF "%cd%"\HardLaunch\VS\B35\BF /E /Y /I
xcopy "%cd%"\Moth_Skins\Vanilla "%cd%"\HardLaunch\VS\B35\Moth_Skins\Vanilla /E /Y /I
REG ADD HKEY_CURRENT_USER\SOFTWARE\Refinery\HmanB35\Config /v Skin0 /t REG_SZ /d "%cd%"\HardLaunch\VS\B35\Moth_Skins\Vanilla\moth_moon.bmp /f
REG ADD HKEY_CURRENT_USER\SOFTWARE\Refinery\HmanB35\Config /v Skin1 /t REG_SZ /d "%cd%"\HardLaunch\VS\B35\Moth_Skins\Vanilla\moth_silver.bmp /f
REG ADD HKEY_CURRENT_USER\SOFTWARE\Refinery\HmanB35\Config /v Skin2 /t REG_SZ /d "%cd%"\HardLaunch\VS\B35\Moth_Skins\Vanilla\moth_neo.bmp /f
REG ADD HKEY_CURRENT_USER\SOFTWARE\Refinery\HmanB35\Config /v Skin3 /t REG_SZ /d "%cd%"\HardLaunch\VS\B35\Moth_Skins\Vanilla\moth_hawk.bmp /f
REG ADD HKEY_CURRENT_USER\SOFTWARE\Refinery\HmanB35\Config /v Skin4 /t REG_SZ /d "%cd%"\HardLaunch\VS\B35\Moth_Skins\Vanilla\moth_death.bmp /f
REG ADD HKEY_CURRENT_USER\SOFTWARE\Refinery\HmanB35\Config /v Skin5 /t REG_SZ /d "%cd%"\HardLaunch\VS\B35\Moth_Skins\Vanilla\moth_police.bmp /f
REG ADD HKEY_CURRENT_USER\SOFTWARE\Refinery\HmanB35\Config /v Skin6 /t REG_SZ /d "%cd%"\HardLaunch\VS\B35\Moth_Skins\Vanilla\moth_swallow.bmp /f
...
REG ADD HKEY_CURRENT_USER\SOFTWARE\Refinery\HmanB35\Config /v KamFong /t REG_SZ /d ChinHo /f
...
copy libogg-0.dll "%cd%"\HardLaunch\VS\B35\libogg-0.dll
copy libvorbis-0.dll "%cd%"\HardLaunch\VS\B35\libvorbis-0.dll
copy libvorbisfile-3.dll "%cd%"\HardLaunch\VS\B35\libvorbisfile-3.dll
copy winmm.dll "%cd%"\HardLaunch\VS\B35\winmm.dll
...
xcopy "%cd%"\Music "%cd%"\HardLaunch\VS\UM1\Music /E /Y /I
xcopy "%cd%"\HardLaunch\BF "%cd%"\HardLaunch\VS\UM1\BF /E /Y /I
xcopy "%cd%"\Moth_Skins\Vanilla "%cd%"\HardLaunch\VS\UM1\Moth_Skins\Vanilla /E /Y /I
REG ADD HKEY_CURRENT_USER\SOFTWARE\Refinery\HmanUM1\Config /v Skin0 /t REG_SZ /d "%cd%"\HardLaunch\VS\UM1\Moth_Skins\Vanilla\moth_moon.bmp /f
REG ADD HKEY_CURRENT_USER\SOFTWARE\Refinery\HmanUM1\Config /v Skin1 /t REG_SZ /d "%cd%"\HardLaunch\VS\UM1\Moth_Skins\Vanilla\moth_silver.bmp /f
REG ADD HKEY_CURRENT_USER\SOFTWARE\Refinery\HmanUM1\Config /v Skin2 /t REG_SZ /d "%cd%"\HardLaunch\VS\UM1\Moth_Skins\Vanilla\moth_neo.bmp /f
REG ADD HKEY_CURRENT_USER\SOFTWARE\Refinery\HmanUM1\Config /v Skin3 /t REG_SZ /d "%cd%"\HardLaunch\VS\UM1\Moth_Skins\Vanilla\moth_hawk.bmp /f
REG ADD HKEY_CURRENT_USER\SOFTWARE\Refinery\HmanUM1\Config /v Skin4 /t REG_SZ /d "%cd%"\HardLaunch\VS\UM1\Moth_Skins\Vanilla\moth_death.bmp /f
REG ADD HKEY_CURRENT_USER\SOFTWARE\Refinery\HmanUM1\Config /v Skin5 /t REG_SZ /d "%cd%"\HardLaunch\VS\UM1\Moth_Skins\Vanilla\moth_police.bmp /f
REG ADD HKEY_CURRENT_USER\SOFTWARE\Refinery\HmanUM1\Config /v Skin6 /t REG_SZ /d "%cd%"\HardLaunch\VS\UM1\Moth_Skins\Vanilla\moth_swallow.bmp /f
...
REG ADD HKEY_CURRENT_USER\SOFTWARE\Refinery\HmanUM1\Config /v KamFong /t REG_SZ /d ChinHo /f
...
copy libogg-0.dll "%cd%"\HardLaunch\VS\UM1\libogg-0.dll
copy libvorbis-0.dll "%cd%"\HardLaunch\VS\UM1\libvorbis-0.dll
copy libvorbisfile-3.dll "%cd%"\HardLaunch\VS\UM1\libvorbisfile-3.dll
copy winmm.dll "%cd%"\HardLaunch\VS\UM1\winmm.dll
...
@echo off
set "currentDirectory=%cd%"
regedit /s "%~dp0\HardLaunch\VS\UM2\um2.reg"
xcopy "%cd%"\Music "%cd%"\HardLaunch\VS\UM2\Music /E /Y /I
xcopy "%cd%"\HardLaunch\BF "%cd%"\HardLaunch\VS\UM2\BF /E /Y /I
xcopy "%cd%"\Moth_Skins\Vanilla "%cd%"\HardLaunch\VS\UM2\Moth_Skins\Vanilla /E /Y /I
REG ADD HKEY_CURRENT_USER\SOFTWARE\Refinery\HmanUM2\Config /v Skin0 /t REG_SZ /d "%cd%"\HardLaunch\VS\UM2\Moth_Skins\Vanilla\moth_moon.bmp /f
REG ADD HKEY_CURRENT_USER\SOFTWARE\Refinery\HmanUM2\Config /v Skin1 /t REG_SZ /d "%cd%"\HardLaunch\VS\UM2\Moth_Skins\Vanilla\moth_silver.bmp /f
REG ADD HKEY_CURRENT_USER\SOFTWARE\Refinery\HmanUM2\Config /v Skin2 /t REG_SZ /d "%cd%"\HardLaunch\VS\UM2\Moth_Skins\Vanilla\moth_neo.bmp /f
REG ADD HKEY_CURRENT_USER\SOFTWARE\Refinery\HmanUM2\Config /v Skin3 /t REG_SZ /d "%cd%"\HardLaunch\VS\UM2\Moth_Skins\Vanilla\moth_hawk.bmp /f
REG ADD HKEY_CURRENT_USER\SOFTWARE\Refinery\HmanUM2\Config /v Skin4 /t REG_SZ /d "%cd%"\HardLaunch\VS\UM2\Moth_Skins\Vanilla\moth_death.bmp /f
REG ADD HKEY_CURRENT_USER\SOFTWARE\Refinery\HmanUM2\Config /v Skin5 /t REG_SZ /d "%cd%"\HardLaunch\VS\UM2\Moth_Skins\Vanilla\moth_police.bmp /f
REG ADD HKEY_CURRENT_USER\SOFTWARE\Refinery\HmanUM2\Config /v Skin6 /t REG_SZ /d "%cd%"\HardLaunch\VS\UM2\Moth_Skins\Vanilla\moth_swallow.bmp /f
REG ADD HKEY_CURRENT_USER\SOFTWARE\Refinery\HmanUM2\Config /v SkinsOn /t REG_DWORD /d 0x00000000 /f
REG ADD HKEY_CURRENT_USER\SOFTWARE\Refinery\HmanUM2\Config /v SkinDir /t REG_SZ /d "%cd%"\HardLaunch\VS\UM2\Moth_Skins\ /f
REG ADD HKEY_CURRENT_USER\SOFTWARE\Refinery\HmanUM2\Config /v DataPath /t REG_SZ /d "%cd%"\HardLaunch\VS\UM2\ /f
REG ADD HKEY_CURRENT_USER\SOFTWARE\Refinery\HmanUM2\Config /v DataPath2 /t REG_SZ /d "%cd%"\HardLaunch\VS\UM2\ /f
REG ADD HKEY_CURRENT_USER\SOFTWARE\Refinery\HmanUM2\Config /v GDVPath /t REG_SZ /d "%cd%"\HardLaunch\VS\UM2\GDV\ /f
REG ADD HKEY_CURRENT_USER\SOFTWARE\Refinery\HmanUM2\Config /v GDVPath2 /t REG_SZ /d "%cd%"\HardLaunch\VS\UM2\GDV\ /f
REG ADD HKEY_CURRENT_USER\SOFTWARE\Refinery\HmanUM2\Config /v GDVPath3 /t REG_SZ /d "%cd%"\HardLaunch\VS\UM2\GDV\ /f
REG ADD HKEY_CURRENT_USER\SOFTWARE\Refinery\HmanUM2\Config /v RunPath /t REG_SZ /d "%cd%"\HardLaunch\VS\UM2\ /f
REG ADD HKEY_CURRENT_USER\SOFTWARE\Refinery\HmanUM2\Config /v SavePath /t REG_SZ /d "%cd%"\HardLaunch\VS\UM2\Savegames\ /f
REG ADD HKEY_CURRENT_USER\SOFTWARE\Refinery\HmanUM2\Config /v SourcePath /t REG_SZ /d "%cd%"\HardLaunch\VS\UM2\ /f
REG ADD HKEY_CURRENT_USER\SOFTWARE\Refinery\HmanUM2\Config /v KamFong /t REG_SZ /d ChinHo /f
copy "%cd%"\DATA\Hardup.res "%cd%"\HardLaunch\VS\UM2\Hardup.res
copy "%cd%"\HardLaunch\#Dependencies\dgVoodooCpl.exe "%cd%"\HardLaunch\VS\UM2\dgVoodooCpl.exe
copy "%cd%"\HardLaunch\#Dependencies\dgVoodoo.conf "%cd%"\HardLaunch\VS\UM2\dgVoodoo.conf
copy "%cd%"\HardLaunch\#Dependencies\DDraw.dll "%cd%"\HardLaunch\VS\UM2\DDraw.dll
copy "%cd%"\HardLaunch\#Dependencies\D3DImm.dll "%cd%"\HardLaunch\VS\UM2\D3DImm.dll
copy "%cd%"\HardLaunch\#Dependencies\D3D9.dll "%cd%"\HardLaunch\VS\UM2\D3D9.dll
copy "%cd%"\HardLaunch\#Dependencies\D3D8.dll "%cd%"\HardLaunch\VS\UM2\D3D8.dll
copy DSetup.DLL "%cd%"\HardLaunch\VS\UM2\DSetup.DLL
copy libogg-0.dll "%cd%"\HardLaunch\VS\UM2\libogg-0.dll
copy libvorbis-0.dll "%cd%"\HardLaunch\VS\UM2\libvorbis-0.dll
copy libvorbisfile-3.dll "%cd%"\HardLaunch\VS\UM2\libvorbisfile-3.dll
copy winmm.dll "%cd%"\HardLaunch\VS\UM2\winmm.dll
"%cd%"\HardLaunch\#Dependencies\xdelta3.exe -d -s "%cd%"\HardLaunch\EXE\Backups\HardwarWUIM06.exe "%cd%"\HardLaunch\VS\UM2\Patches\HWW_UIM06toUM2.xdelta "%cd%"\HardLaunch\VS\UM2\HardWUM2.exe
"%cd%"\HardLaunch\#Dependencies\xdelta3.exe -d -s "%cd%"\HardLaunch\EXE\Backups\HardmanUIM06.exe "%cd%"\HardLaunch\VS\UM2\Patches\HMAN_UIM06toUM2.xdelta "%cd%"\HardLaunch\VS\UM2\HmanUM2.exe
"%cd%"\HardLaunch\#Dependencies\xdelta3.exe -d -s "%cd%"\HardLaunch\RES\Backups\HardimUIM06.res "%cd%"\HardLaunch\VS\UM2\Patches\HIM_UIM06toUM2.xdelta "%cd%"\HardLaunch\VS\UM2\Hardim.res
"%cd%"\HardLaunch\#Dependencies\xdelta3.exe -d -s "%cd%"\HardLaunch\RES\Backups\HardwarUIM06.res "%cd%"\HardLaunch\VS\UM2\Patches\HWR_UIM06toUM2.xdelta "%cd%"\HardLaunch\VS\UM2\HardUM2.res
cd /D "%cd%"\HardLaunch\VS\UM2 && HardLaunchUM2.bat
@echo off
goto end
...
xcopy "%cd%"\Music "%cd%"\HardLaunch\VS\U21\Music /E /Y /I
xcopy "%cd%"\HardLaunch\BF "%cd%"\HardLaunch\VS\U21\BF /E /Y /I
xcopy "%cd%"\Moth_Skins\Vanilla "%cd%"\HardLaunch\VS\U21\Moth_Skins\Vanilla /E /Y /I
REG ADD HKEY_CURRENT_USER\SOFTWARE\Refinery\HmanU21\Config /v Skin0 /t REG_SZ /d "%cd%"\HardLaunch\VS\U21\Moth_Skins\Vanilla\moth_moon.bmp /f
REG ADD HKEY_CURRENT_USER\SOFTWARE\Refinery\HmanU21\Config /v Skin1 /t REG_SZ /d "%cd%"\HardLaunch\VS\U21\Moth_Skins\Vanilla\moth_silver.bmp /f
REG ADD HKEY_CURRENT_USER\SOFTWARE\Refinery\HmanU21\Config /v Skin2 /t REG_SZ /d "%cd%"\HardLaunch\VS\U21\Moth_Skins\Vanilla\moth_neo.bmp /f
REG ADD HKEY_CURRENT_USER\SOFTWARE\Refinery\HmanU21\Config /v Skin3 /t REG_SZ /d "%cd%"\HardLaunch\VS\U21\Moth_Skins\Vanilla\moth_hawk.bmp /f
REG ADD HKEY_CURRENT_USER\SOFTWARE\Refinery\HmanU21\Config /v Skin4 /t REG_SZ /d "%cd%"\HardLaunch\VS\U21\Moth_Skins\Vanilla\moth_death.bmp /f
REG ADD HKEY_CURRENT_USER\SOFTWARE\Refinery\HmanU21\Config /v Skin5 /t REG_SZ /d "%cd%"\HardLaunch\VS\U21\Moth_Skins\Vanilla\moth_police.bmp /f
REG ADD HKEY_CURRENT_USER\SOFTWARE\Refinery\HmanU21\Config /v Skin6 /t REG_SZ /d "%cd%"\HardLaunch\VS\U21\Moth_Skins\Vanilla\moth_swallow.bmp /f
...
REG ADD HKEY_CURRENT_USER\SOFTWARE\Refinery\HmanU21\Config /v KamFong /t REG_SZ /d ChinHo /f
...
copy libogg-0.dll "%cd%"\HardLaunch\VS\U21\libogg-0.dll
copy libvorbis-0.dll "%cd%"\HardLaunch\VS\U21\libvorbis-0.dll
copy libvorbisfile-3.dll "%cd%"\HardLaunch\VS\U21\libvorbisfile-3.dll
copy winmm.dll "%cd%"\HardLaunch\VS\U21\winmm.dll
...
xcopy "%cd%"\Music "%cd%"\HardLaunch\VS\UM3\Music /E /Y /I
xcopy "%cd%"\HardLaunch\BF "%cd%"\HardLaunch\VS\UM1\BF /E /Y /I
xcopy "%cd%"\Moth_Skins\Vanilla "%cd%"\HardLaunch\VS\UM3\Moth_Skins\Vanilla /E /Y /I
REG ADD HKEY_CURRENT_USER\SOFTWARE\Refinery\HmanUM3\Config /v Skin0 /t REG_SZ /d "%cd%"\HardLaunch\VS\UM3\Moth_Skins\Vanilla\moth_moon.bmp /f
REG ADD HKEY_CURRENT_USER\SOFTWARE\Refinery\HmanUM3\Config /v Skin1 /t REG_SZ /d "%cd%"\HardLaunch\VS\UM3\Moth_Skins\Vanilla\moth_silver.bmp /f
REG ADD HKEY_CURRENT_USER\SOFTWARE\Refinery\HmanUM3\Config /v Skin2 /t REG_SZ /d "%cd%"\HardLaunch\VS\UM3\Moth_Skins\Vanilla\moth_neo.bmp /f
REG ADD HKEY_CURRENT_USER\SOFTWARE\Refinery\HmanUM3\Config /v Skin3 /t REG_SZ /d "%cd%"\HardLaunch\VS\UM3\Moth_Skins\Vanilla\moth_hawk.bmp /f
REG ADD HKEY_CURRENT_USER\SOFTWARE\Refinery\HmanUM3\Config /v Skin4 /t REG_SZ /d "%cd%"\HardLaunch\VS\UM3\Moth_Skins\Vanilla\moth_death.bmp /f
REG ADD HKEY_CURRENT_USER\SOFTWARE\Refinery\HmanUM3\Config /v Skin5 /t REG_SZ /d "%cd%"\HardLaunch\VS\UM3\Moth_Skins\Vanilla\moth_police.bmp /f
REG ADD HKEY_CURRENT_USER\SOFTWARE\Refinery\HmanUM3\Config /v Skin6 /t REG_SZ /d "%cd%"\HardLaunch\VS\UM3\Moth_Skins\Vanilla\moth_swallow.bmp /f
...
REG ADD HKEY_CURRENT_USER\SOFTWARE\Refinery\HmanUM3\Config /v KamFong /t REG_SZ /d ChinHo /f
...
copy libogg-0.dll "%cd%"\HardLaunch\VS\UM3\libogg-0.dll
copy libvorbis-0.dll "%cd%"\HardLaunch\VS\UM3\libvorbis-0.dll
copy libvorbisfile-3.dll "%cd%"\HardLaunch\VS\UM3\libvorbisfile-3.dll
copy winmm.dll "%cd%"\HardLaunch\VS\UM3\winmm.dll
...
xcopy "%cd%"\Music "%cd%"\HardLaunch\VS\UM4\Music /E /Y /I
xcopy "%cd%"\Moth_Skins\Vanilla "%cd%"\HardLaunch\VS\UM4\Moth_Skins\Vanilla /E /Y /I
REG ADD HKEY_CURRENT_USER\SOFTWARE\Refinery\HmanUM4\Config /v Skin0 /t REG_SZ /d "%cd%"\HardLaunch\VS\UM4\Moth_Skins\Vanilla\moth_moon.bmp /f
REG ADD HKEY_CURRENT_USER\SOFTWARE\Refinery\HmanUM4\Config /v Skin1 /t REG_SZ /d "%cd%"\HardLaunch\VS\UM4\Moth_Skins\Vanilla\moth_silver.bmp /f
REG ADD HKEY_CURRENT_USER\SOFTWARE\Refinery\HmanUM4\Config /v Skin2 /t REG_SZ /d "%cd%"\HardLaunch\VS\UM4\Moth_Skins\Vanilla\moth_neo.bmp /f
REG ADD HKEY_CURRENT_USER\SOFTWARE\Refinery\HmanUM4\Config /v Skin3 /t REG_SZ /d "%cd%"\HardLaunch\VS\UM4\Moth_Skins\Vanilla\moth_hawk.bmp /f
REG ADD HKEY_CURRENT_USER\SOFTWARE\Refinery\HmanUM4\Config /v Skin4 /t REG_SZ /d "%cd%"\HardLaunch\VS\UM4\Moth_Skins\Vanilla\moth_death.bmp /f
REG ADD HKEY_CURRENT_USER\SOFTWARE\Refinery\HmanUM4\Config /v Skin5 /t REG_SZ /d "%cd%"\HardLaunch\VS\UM4\Moth_Skins\Vanilla\moth_police.bmp /f
REG ADD HKEY_CURRENT_USER\SOFTWARE\Refinery\HmanUM4\Config /v Skin6 /t REG_SZ /d "%cd%"\HardLaunch\VS\UM4\Moth_Skins\Vanilla\moth_swallow.bmp /f
...
REG ADD HKEY_CURRENT_USER\SOFTWARE\Refinery\HmanUM4\Config /v GDVPath /t REG_SZ /d "%cd%"\GDV\ /f
REG ADD HKEY_CURRENT_USER\SOFTWARE\Refinery\HmanUM4\Config /v GDVPath2 /t REG_SZ /d "%cd%"\GDV\ /f
REG ADD HKEY_CURRENT_USER\SOFTWARE\Refinery\HmanUM4\Config /v GDVPath3 /t REG_SZ /d "%cd%"\GDV\ /f
...
REG ADD HKEY_CURRENT_USER\SOFTWARE\Refinery\HmanUM4\Config /v KamFong /t REG_SZ /d ChinHo /f
...
copy libogg-0.dll "%cd%"\HardLaunch\VS\UM4\libogg-0.dll
copy libvorbis-0.dll "%cd%"\HardLaunch\VS\UM4\libvorbis-0.dll
copy libvorbisfile-3.dll "%cd%"\HardLaunch\VS\UM4\libvorbisfile-3.dll
copy winmm.dll "%cd%"\HardLaunch\VS\UM4\winmm.dll
...
xcopy "%cd%"\Music "%cd%"\HardLaunch\VS\UM5\Music /E /Y /I
xcopy "%cd%"\Moth_Skins\Vanilla "%cd%"\HardLaunch\VS\UM5\Moth_Skins\Vanilla /E /Y /I
REG ADD HKEY_CURRENT_USER\SOFTWARE\Refinery\HmanUM5\Config /v Skin0 /t REG_SZ /d "%cd%"\HardLaunch\VS\UM5\Moth_Skins\Vanilla\moth_moon.bmp /f
REG ADD HKEY_CURRENT_USER\SOFTWARE\Refinery\HmanUM5\Config /v Skin1 /t REG_SZ /d "%cd%"\HardLaunch\VS\UM5\Moth_Skins\Vanilla\moth_silver.bmp /f
REG ADD HKEY_CURRENT_USER\SOFTWARE\Refinery\HmanUM5\Config /v Skin2 /t REG_SZ /d "%cd%"\HardLaunch\VS\UM5\Moth_Skins\Vanilla\moth_neo.bmp /f
REG ADD HKEY_CURRENT_USER\SOFTWARE\Refinery\HmanUM5\Config /v Skin3 /t REG_SZ /d "%cd%"\HardLaunch\VS\UM5\Moth_Skins\Vanilla\moth_hawk.bmp /f
REG ADD HKEY_CURRENT_USER\SOFTWARE\Refinery\HmanUM5\Config /v Skin4 /t REG_SZ /d "%cd%"\HardLaunch\VS\UM5\Moth_Skins\Vanilla\moth_death.bmp /f
REG ADD HKEY_CURRENT_USER\SOFTWARE\Refinery\HmanUM5\Config /v Skin5 /t REG_SZ /d "%cd%"\HardLaunch\VS\UM5\Moth_Skins\Vanilla\moth_police.bmp /f
REG ADD HKEY_CURRENT_USER\SOFTWARE\Refinery\HmanUM5\Config /v Skin6 /t REG_SZ /d "%cd%"\HardLaunch\VS\UM5\Moth_Skins\Vanilla\moth_swallow.bmp /f
...
REG ADD HKEY_CURRENT_USER\SOFTWARE\Refinery\HmanUM5\Config /v GDVPath /t REG_SZ /d "%cd%"\GDV\ /f
REG ADD HKEY_CURRENT_USER\SOFTWARE\Refinery\HmanUM5\Config /v GDVPath2 /t REG_SZ /d "%cd%"\GDV\ /f
REG ADD HKEY_CURRENT_USER\SOFTWARE\Refinery\HmanUM5\Config /v GDVPath3 /t REG_SZ /d "%cd%"\GDV\ /f
...
REG ADD HKEY_CURRENT_USER\SOFTWARE\Refinery\HmanUM5\Config /v KamFong /t REG_SZ /d ChinHo /f
...
copy libogg-0.dll "%cd%"\HardLaunch\VS\UM5\libogg-0.dll
copy libvorbis-0.dll "%cd%"\HardLaunch\VS\UM5\libvorbis-0.dll
copy libvorbisfile-3.dll "%cd%"\HardLaunch\VS\UM5\libvorbisfile-3.dll
copy winmm.dll "%cd%"\HardLaunch\VS\UM5\winmm.dll
...
@echo off
set "currentDirectory=%cd%"
regedit /s "%~dp0\HardLaunch\VS\Enh\enh.reg"
xcopy "%cd%"\Music "%cd%"\HardLaunch\VS\Enh\Music /E /Y /I
xcopy "%cd%"\Moth_Skins\Vanilla "%cd%"\HardLaunch\VS\Enh\Moth_Skins\Vanilla /E /Y /I
REG ADD HKEY_CURRENT_USER\SOFTWARE\Refinery\HmanEnh\Config /v Skin0 /t REG_SZ /d "%cd%"\HardLaunch\VS\Enh\Moth_Skins\Vanilla\moth_moon.bmp /f
REG ADD HKEY_CURRENT_USER\SOFTWARE\Refinery\HmanEnh\Config /v Skin1 /t REG_SZ /d "%cd%"\HardLaunch\VS\Enh\Moth_Skins\Vanilla\moth_silver.bmp /f
REG ADD HKEY_CURRENT_USER\SOFTWARE\Refinery\HmanEnh\Config /v Skin2 /t REG_SZ /d "%cd%"\HardLaunch\VS\Enh\Moth_Skins\Vanilla\moth_neo.bmp /f
REG ADD HKEY_CURRENT_USER\SOFTWARE\Refinery\HmanEnh\Config /v Skin3 /t REG_SZ /d "%cd%"\HardLaunch\VS\Enh\Moth_Skins\Vanilla\moth_hawk.bmp /f
REG ADD HKEY_CURRENT_USER\SOFTWARE\Refinery\HmanEnh\Config /v Skin4 /t REG_SZ /d "%cd%"\HardLaunch\VS\Enh\Moth_Skins\Vanilla\moth_death.bmp /f
REG ADD HKEY_CURRENT_USER\SOFTWARE\Refinery\HmanEnh\Config /v Skin5 /t REG_SZ /d "%cd%"\HardLaunch\VS\Enh\Moth_Skins\Vanilla\moth_police.bmp /f
REG ADD HKEY_CURRENT_USER\SOFTWARE\Refinery\HmanEnh\Config /v Skin6 /t REG_SZ /d "%cd%"\HardLaunch\VS\Enh\Moth_Skins\Vanilla\moth_swallow.bmp /f
REG ADD HKEY_CURRENT_USER\SOFTWARE\Refinery\HmanEnh\Config /v SkinsOn /t REG_DWORD /d 0x00000000 /f
REG ADD HKEY_CURRENT_USER\SOFTWARE\Refinery\HmanEnh\Config /v SkinDir /t REG_SZ /d "%cd%"\HardLaunch\VS\Enh\Moth_Skins\ /f
REG ADD HKEY_CURRENT_USER\SOFTWARE\Refinery\HmanEnh\Config /v DataPath /t REG_SZ /d "%cd%"\HardLaunch\VS\Enh\ /f
REG ADD HKEY_CURRENT_USER\SOFTWARE\Refinery\HmanEnh\Config /v DataPath2 /t REG_SZ /d "%cd%"\HardLaunch\VS\Enh\ /f
REG ADD HKEY_CURRENT_USER\SOFTWARE\Refinery\HmanEnh\Config /v GDVPath /t REG_SZ /d "%cd%"\GDV\ /f
REG ADD HKEY_CURRENT_USER\SOFTWARE\Refinery\HmanEnh\Config /v GDVPath2 /t REG_SZ /d "%cd%"\GDV\ /f
REG ADD HKEY_CURRENT_USER\SOFTWARE\Refinery\HmanEnh\Config /v GDVPath3 /t REG_SZ /d "%cd%"\GDV\ /f
REG ADD HKEY_CURRENT_USER\SOFTWARE\Refinery\HmanEnh\Config /v RunPath /t REG_SZ /d "%cd%"\HardLaunch\VS\Enh\ /f
REG ADD HKEY_CURRENT_USER\SOFTWARE\Refinery\HmanEnh\Config /v SavePath /t REG_SZ /d "%cd%"\HardLaunch\VS\Enh\Savegames\ /f
REG ADD HKEY_CURRENT_USER\SOFTWARE\Refinery\HmanEnh\Config /v SourcePath /t REG_SZ /d "%cd%"\HardLaunch\VS\Enh\ /f
REG ADD HKEY_CURRENT_USER\SOFTWARE\Refinery\HmanEnh\Config /v KamFong /t REG_SZ /d ChinHo /f
copy "%cd%"\HardLaunch\RES\Backups\HardupUIM06.res "%cd%"\HardLaunch\VS\Enh\Hardup.res
copy "%cd%"\HardLaunch\RES\Backups\HardwarUIM06.res "%cd%"\HardLaunch\VS\Enh\HardEnh.res
copy "%cd%"\HardLaunch\RES\Backups\HardimUIM06.res "%cd%"\HardLaunch\VS\Enh\Hardim.res
copy DSetup.DLL "%cd%"\HardLaunch\VS\Enh\DSetup.DLL
copy libogg-0.dll "%cd%"\HardLaunch\VS\Enh\libogg-0.dll
copy libvorbis-0.dll "%cd%"\HardLaunch\VS\Enh\libvorbis-0.dll
copy libvorbisfile-3.dll "%cd%"\HardLaunch\VS\Enh\libvorbisfile-3.dll
copy winmm.dll "%cd%"\HardLaunch\VS\Enh\winmm.dll
copy z_hardwar.DLL "%cd%"\HardLaunch\VS\Enh\z_hardwar.DLL
copy rock_e.bmp "%cd%"\HardLaunch\VS\Enh\rock_e.bmp
copy met_e.bmp "%cd%"\HardLaunch\VS\Enh\met_e.bmp
copy "%cd%"\HardLaunch\#Dependencies\xdelta3.exe "%cd%"\HardLaunch\VS\Enh\#Dependencies\xdelta3.exe
"%cd%"\HardLaunch\#Dependencies\xdelta3.exe -d -s "%cd%"\HardLaunch\EXE\Backups\HardwarWUIM06.exe "%cd%"\HardLaunch\VS\Enh\Patches\HWW_UIM06toEnh.xdelta "%cd%"\HardLaunch\VS\Enh\HardWEnh.exe
"%cd%"\HardLaunch\#Dependencies\xdelta3.exe -d -s "%cd%"\HardLaunch\EXE\Backups\HardmanUIM06.exe "%cd%"\HardLaunch\VS\Enh\Patches\HMAN_UIM06toEnh.xdelta "%cd%"\HardLaunch\VS\Enh\HmanEnh.exe
"%cd%"\HardLaunch\#Dependencies\xdelta3.exe -d -s "%cd%"\HardLaunch\EXE\Backups\HardmanUIM06.exe "%cd%"\HardLaunch\VS\Enh\Patches\HMAN_UIM06toEnhEopt.xdelta "%cd%"\HardLaunch\VS\Enh\HmanEnhEopt.exe
"%cd%"\HardLaunch\#Dependencies\xdelta3.exe -d -s "%cd%"\HardLaunch\VS\Enh\Patches\HmanEnh "%cd%"\HardLaunch\VS\Enh\Patches\enh-4-10-05.xdelta "%cd%"\HardLaunch\VS\Enh\enhanced.e
"%cd%"\HardLaunch\#Dependencies\xdelta3.exe -d -s "%cd%"\HardLaunch\VS\Enh\Patches\HmanEnh "%cd%"\HardLaunch\VS\Enh\Patches\enh2-7-3-05.xdelta "%cd%"\HardLaunch\VS\Enh\enhanced2.e
"%cd%"\HardLaunch\#Dependencies\xdelta3.exe -d -s "%cd%"\HardLaunch\VS\Enh\Patches\HmanEnh "%cd%"\HardLaunch\VS\Enh\Patches\enh-idat-4-10-05.xdelta "%cd%"\HardLaunch\VS\Enh\itemdat.d
"%cd%"\HardLaunch\#Dependencies\xdelta3.exe -d -s "%cd%"\HardLaunch\VS\Enh\Patches\HmanEnh "%cd%"\HardLaunch\VS\Enh\Patches\enh-mdat-4-10-05.xdelta "%cd%"\HardLaunch\VS\Enh\manufdat.d
ren "%cd%"\HardLaunch\VS\Enh\enhanced.e enhanced
ren "%cd%"\HardLaunch\VS\Enh\enhanced2.e enhanced2
ren "%cd%"\HardLaunch\VS\Enh\itemdat.d itemdat
ren "%cd%"\HardLaunch\VS\Enh\manufdat.d manufdat
del "%cd%"\HardLaunch\VS\Enh\enhanced.e
del "%cd%"\HardLaunch\VS\Enh\enhanced2.e
del "%cd%"\HardLaunch\VS\Enh\itemdat.d
del "%cd%"\HardLaunch\VS\Enh\manufdat.d
cd /D "%cd%"\HardLaunch\VS\Enh && HardLaunchEnh.bat
@echo off
goto end
...
if %regclean%==y REG DELETE HKEY_CURRENT_USER\SOFTWARE\Refinery\HmanF12 /f
...
if %regclean%==y REG DELETE HKEY_CURRENT_USER\SOFTWARE\Refinery\HmanU10 /f
...
if %regclean%==y REG DELETE HKEY_CURRENT_USER\SOFTWARE\Refinery\HmanUM2 /f
...
if %regclean%==y REG DELETE HKEY_CURRENT_USER\SOFTWARE\Refinery\HmanEnh /f
...
@echo off
set "currentDirectory=%cd%"
if %setdirectory%==y REG ADD HKEY_CURRENT_USER\SOFTWARE\Refinery\Hardman\Config /v Skin0 /t REG_SZ /d "%cd%"\Moth_Skins\Vanilla\moth_moon.bmp /f
@echo off
if %setdirectory%==y REG ADD HKEY_CURRENT_USER\SOFTWARE\Refinery\Hardman\Config /v Skin1 /t REG_SZ /d "%cd%"\Moth_Skins\Vanilla\moth_silver.bmp /f
@echo off
if %setdirectory%==y REG ADD HKEY_CURRENT_USER\SOFTWARE\Refinery\Hardman\Config /v Skin2 /t REG_SZ /d "%cd%"\Moth_Skins\Vanilla\moth_neo.bmp /f
@echo off
if %setdirectory%==y REG ADD HKEY_CURRENT_USER\SOFTWARE\Refinery\Hardman\Config /v Skin3 /t REG_SZ /d "%cd%"\Moth_Skins\Vanilla\moth_hawk.bmp /f
@echo off
if %setdirectory%==y REG ADD HKEY_CURRENT_USER\SOFTWARE\Refinery\Hardman\Config /v Skin4 /t REG_SZ /d "%cd%"\Moth_Skins\Vanilla\moth_death.bmp /f
@echo off
if %setdirectory%==y REG ADD HKEY_CURRENT_USER\SOFTWARE\Refinery\Hardman\Config /v Skin5 /t REG_SZ /d "%cd%"\Moth_Skins\Vanilla\moth_police.bmp /f
@echo off
if %setdirectory%==y REG ADD HKEY_CURRENT_USER\SOFTWARE\Refinery\Hardman\Config /v Skin6 /t REG_SZ /d "%cd%"\Moth_Skins\Vanilla\moth_swallow.bmp /f
@echo off
